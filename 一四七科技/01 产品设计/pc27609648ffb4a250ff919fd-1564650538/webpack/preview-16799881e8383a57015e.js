(window.webpackJsonp=window.webpackJsonp||[]).push([[14],{"+Cau":function(e,t,a){"use strict"
var n=a("TqRt")
...
return{getState:t,dispatch:a,state:n,project:o,isHighlight:r}}},"/5+U":function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.immutableTransformCache=function(e){var t,a
return function(){return function(e,t){if(!e||e.length!==t.length)return!1
for(var a=0,n=e.length;a<n;a++)if(e[a]!==t[a])return!1
return!0}(a,arguments)||(t=e.apply(null,arguments),a=arguments),t}},t.canBackToWorkspace=t.delRecentColor=t.saveRecentColor=t.getHistoryColor=t.isChinese=t.isEnglish=t.downloadFail=t.setTimeoutAsync=t.getMinBoundingRect=t.save2Digital=t.downloadWithATag=t.adjustImageRect=t.adapterScreen=t.unescapeHTML=void 0
function n(e){return r[e]||e}var r={"&amp;":"&","&lt;":"<","&gt;":">"},i=/(&amp;|&lt;|&gt;)/g
t.unescapeHTML=function(e){return e&&e.replace(i,n)}
t.adapterScreen=function(e,t,a){var n=2<arguments.length&&void 0!==a?a:0
return Number(parseFloat((1/(1<arguments.length&&void 0!==t?t:1)*(0<arguments.length&&void 0!==e?e:0)).toFixed(2)))+n}
t.adjustImageRect=function(e){var t=e.image,a=e.adjust,n=t.naturalWidth
t.naturalHeight<=n?t.style.maxWidth=a+"px":t.style.maxHeight=a+"px"}
var l=/\s|<|>|《|》|:|：|？|\?|\\|\/|"|”|\||\./g
t.downloadWithATag=function(e){var t=e.url,a=e.name,n=e.type,r=document.createElement("a"),i=function(e){return e&&e.replace(l,"_")}(a)||"未命名",o="".concat(encodeURIComponent(i))
n?r.href="".concat(t,"?attname=").concat(o,".").concat(n):(r.setAttribute("download",o),r.href="".concat(t)),r.click()}
t.save2Digital=function(e){return Number(e.toFixed(2))}
t.getMinBoundingRect=function(e){var t=e.width,a=e.height,n=e.left,r=e.top,i=e.rotate,o=void 0===i?0:i
if(0===o)return[r,n,t,a]
var l=MB.atan2(t,a),s=l-o,c=s-2*l,u=180+s,d=180+c,f=n+t/2,p=r+a/2,h=MB.hypotenuse(t/2,a/2),m=1/0,v=1/0,g=-1/0,y=-1/0
return[s,c,u,d].forEach(function(e){var t=Math.round(f+h*MB.cos(e)),a=Math.round(p+h*MB.sin(e))
t<m&&(m=t),a<v&&(v=a),g<t&&(g=t),y<a&&(y=a)}),[v,m,g-m,y-v]}
...
t.delRecentColor=function(e){var t=o(),a=t.indexOf(e)
return t.splice(a,1),MB.localStorageDelegate.setItem("user_pick_color",JSON.stringify(t)),t}
t.canBackToWorkspace=function(){var t
try{t=(window.parent===window||/^\/app\/(design|preview)/.test(window.parent.location.pathname))&&(MB.isDashboard||!MB.f.inSharing&&"file:"!==window.location.protocol)}catch(e){console.warn(e),t=!1}return t}},"/Mon":function(e,t,a){"use strict"
var n=a("TqRt")
...
"px;box-shadow:0 2px 10px rgba(108,0,0,0.22);border:2px solid #fff;border-radius:100%;background:#ff7100;color:#fbfbfc;transition:all 0.1s ease-in;transform:scale(1);}&.focus > span{transform:scale(1.21);}&.fade > span{opacity:0.5;}"],0,0,-14,-14,28,28,28),b={mouseup:v.MUTE_EVENT,mousedown:v.MUTE_EVENT,mousemove:v.MUTE_EVENT,mouseleave:v.MUTE_EVENT,mouseout:v.MUTE_EVENT,click:v.MUTE_EVENT,dblclick:v.MUTE_EVENT},S=225},"00a+":function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.withTooltip=t.TooltipContext=t.withTheme=t.ThemeContext=void 0
var i=r(a("pVnL")),o=r(a("MVZn")),l=r(a("QILm")),s=r(a("lwsE")),c=r(a("W8MJ")),u=r(a("a1gu")),d=r(a("Nsbk")),f=r(a("7W2i")),p=r(a("lSNA")),h=r(a("17x9")),m=n(a("q1tI")),v={light:"plain",grey:"core",dark:"core"},g=m.default.createContext("light")
t.ThemeContext=g
t.withTheme=function(n){var a=function(e){function t(){return(0,s.default)(this,t),(0,u.default)(this,(0,d.default)(t).apply(this,arguments))}return(0,f.default)(t,e),(0,c.default)(t,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,a=(0,l.default)(e,["forwardedRef"])
return m.default.createElement(g.Consumer,null,function(e){return m.default.createElement(n,(0,o.default)({ref:t,theme:v[e]},a))})}}]),t}(m.PureComponent)
return(0,p.default)(a,"propTypes",{forwardedRef:h.default.object}),m.default.forwardRef(function(e,t){return m.default.createElement(a,(0,i.default)({},e,{forwardedRef:t}))})}
var y=m.default.createContext()
t.TooltipContext=y
t.withTooltip=function(n){var a=function(e){function t(){return(0,s.default)(this,t),(0,u.default)(this,(0,d.default)(t).apply(this,arguments))}return(0,f.default)(t,e),(0,c.default)(t,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,a=(0,l.default)(e,["forwardedRef"])
return m.default.createElement(y.Consumer,null,function(e){return m.default.createElement(n,(0,o.default)({ref:t,tipClassName:e},a))})}}]),t}(m.PureComponent)
return(0,p.default)(a,"propTypes",{forwardedRef:h.default.object}),m.default.forwardRef(function(e,t){return m.default.createElement(a,(0,i.default)({},e,{forwardedRef:t}))})}},"0uCA":function(e,t,a){"use strict"
var n=a("TqRt")
...
t.default=d},"1Uxz":function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.ImageInfo=void 0
var o=r(a("lwsE")),l=r(a("W8MJ")),s=r(a("a1gu")),c=r(a("Nsbk")),u=r(a("PJYZ")),d=r(a("7W2i")),f=r(a("lSNA")),p=n(a("q1tI")),i=r(a("17x9")),h=r(a("sEfC")),m=a("rbsZ"),v=a("/5+U"),g=a("RUem"),y=function(e){function i(){var e,n;(0,o.default)(this,i)
for(var t=arguments.length,a=new Array(t),r=0;r<t;r++)a[r]=arguments[r]
return n=(0,s.default)(this,(e=(0,c.default)(i)).call.apply(e,[this].concat(a))),(0,f.default)((0,u.default)(n),"imageRef",function(e){return n.$image=e}),(0,f.default)((0,u.default)(n),"handleClick",function(){var e=n.props,t=e.imageSetZip,a=e.name
MB&&MB.currentProject&&!MB.currentProject.limitation.inspectable?(0,m.openRenewModal)("inspectable"):(0,v.downloadWithATag)({url:t,name:a,type:"zip"})}),(0,f.default)((0,u.default)(n),"handleOnload",function(){(0,v.adjustImageRect)({image:n.$image,adjust:38}),n.setState({imageLoad:!0})}),(0,f.default)((0,u.default)(n),"handleError",function(){console.error("image info error")}),(0,f.default)((0,u.default)(n),"debounceClick",(0,h.default)(n.handleClick,500,{leading:!0})),n}return(0,d.default)(i,e),(0,
l.default)(i,[{key:"render",value:function(){var e=this.props,t=e.imageSet,a=e.name,n=t[0].src,r={background:"url(".concat(b,") left top"),backgroundSize:"cover"}
return p.default.createElement(g.WrapComponent,null,p.default.createElement("div",{className:"slice-title"},I18N.preview_panel.export,p.default.createElement("span",{onClick:this.debounceClick},I18N.preview_panel.download_single)),p.default.createElement("div",{className:"slice-panel"},p.default.createElement("div",{className:"slice-item-wrap",style:r},p.default.createElement("img",{src:n,alt:a,ref:this.imageRef,onLoad:this.handleOnload,onError:this.handleError})),p.default.createElement("p",{
className:"slice-item-name"},a)))}}]),i}(p.PureComponent)
t.ImageInfo=y,(0,f.default)(y,"propTypes",{imageSetZip:i.default.string,imageSet:i.default.array,name:i.default.string})
var b="/images/preview/slice-bg.png"},"1gVK":function(e,t,a){"use strict"
...
return t},C=function(e){var t=e.org,a=e.team,n=(0,l.refreshProjectFullData)(e)
...
t.requestSnapshotZip=function(e){return(0,n.requestSnapshotZipLocalhost)(e)}},"2b0G":function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var S=n(a("o0o1")),g=n(a("yXPU")),y=n(a("MVZn")),w=a("Edok"),E=a("Clcl"),C=a("RrAf"),f=a("qYFl"),k=window.MB
...
return e[n]=i,e},{})
return n(a)}var t,a,n=e.filterStaleData,r=(0,y.default)({},C.initialSocketState,{userId:k.user.id,projectCidList:[]}),i={"broadcast:user:data":function(e){e.type
...
"free"===t&&"pro"==a||"pro"===t&&"free"==a||k.action("entry:update:upgrade-notice-indicator-status",{status:"TWINKLE"})}},o={"broadcast:project:data":(a=(0,g.default)(S.default.mark(function e(t){var a,n,r,i,o,l,s,c,u,d,f,p,h
...
break}return h=p.value,m=h.className,v=h.action,g=h.object,y=h.extraInfo,e.next=13,x(s,m,v,g,y,r,n)
...
case 30:case"end":return e.stop()}},e,null,[[7,18,22,30],[23,,25,29]])})),function(e){return t.apply(this,arguments)})},l=(0,C.createSocketStore)({initialState:r,socketPayloadListenerMap:i,socketPayloadQueueAsyncListenerMap:o}),s=l.getState,c=l.setState,u=l.addEventListener,d=l.removeEventListener,f=l.destroy,p=l.getIsSocketConnected,h=l.getSocketTimestamp,m=l.sendSocketPayloadAsync
...
var _=function(e,t,a,n){e.has(n.cid)||(0,f.isRemoteMtimeStale)(t,n.cid,n.mtime)||("Team"===t?(0,f.updateTeam)(a,n):"Project"===t?(0,f.updateProject)(a,n):"Collaborator"===t&&(0,f.updateCollaborator)(a,n))},x=function(){var o=(0,g.default)(S.default.mark(function e(t,a,n,r,i,o){var l,s,c,u,d=arguments
...
e.next=5
break
case 5:if("PointComments::Comment"===a||"Comment"===a)return e.abrupt("return",k.webpackInterface&&k.webpackInterface.pushData("comments",n,r))
e.next=7
break
case 7:if("PointComments::Thread"===a||"CommentThread"===a)return e.abrupt("return",k.webpackInterface&&k.webpackInterface.pushData("comment-threads",n,r))
e.next=9
break
...
e.next=15
break
case 15:l.id&&(!(s="Screen"===a?r.cid:r.screen_cid)&&r.screenstate_cid&&(c=Screenstate.find(r.screenstate_cid))&&(s=c.screen_cid),(u=CoWorker.find(l.id)||new CoWorker({cid:l.id,name:l.name,avatar:l.avatar})).screen_cid=s,u.last_seen=new Date,u.save(),k.renderCoWorkers&&k.renderCoWorkers())
...
var S=(0,o.createCacheMap)({valueSizeSumMax:8388608,valueSizeSingleMax:1048576}),s=function(){var t=(0,i.default)(v.default.mark(function e(t){var a,n,r,i,o,l,s,c,u,d,f,p,h
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(a=t.imageElement,t.projectAccessToken,n=t.screenCid,r=t.screenStateCid,i=void 0===r?"default":r,o=t.mode,void 0===o?"thumbnail":o,l=t.version,s=void 0===l?"":l,e.prev=1,u=g.default.SpineModel.Screen.find(n),d=128/Math.max(u.width,u.height),f="".concat(n,"|").concat(i,"|").concat(d),void 0===(c=S.get("".concat(f,"|").concat(s))))return e.next=9,m()({snapshotMode:"png-base64",snapshotUrl:b,taskList:[(0,y.doRenderScreenToHTMLString)({
...
var c=function(){var t=(0,i.default)(v.default.mark(function e(t){var a,n,r,i,o,l
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return t.projectAccessToken,a=t.screenCid,n=t.canvasZoom,r=void 0===n?1:n,i=g.default.SpineModel.Screen.find(a),e.next=5,m()({snapshotMode:"png-file",snapshotUrl:b,snapshotOutputFile:"".concat((0,h.getScreenFileName)(i),".png"),taskList:[(0,y.doRenderScreenToHTMLString)({screenCid:a,screenStateCid:"default",canvasZoom:r})]})
...
var u=function(){var t=(0,i.default)(v.default.mark(function e(t){var a,n,r,i,o,l,s,c,u,d
return v.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return a=t.projectAccessToken,n=t.canvasZoom,r=void 0===n?1:n,i=t.onProgress,o=g.default.SpineModel.Project.findAllByAttribute("access_token",a),l=(0,p.default)(o,1),s=l[0],c=g.default.SpineModel.Screen.findAllByAttribute("project_cid",s.cid),e.next=5,m()({snapshotMode:"png-zip-file",snapshotUrl:b,snapshotOutputFile:"".concat(s.name,".zip"),taskList:c.map(function(e){return(0,f.default)({},(0,y.doRenderScreenToHTMLString)({
...
if(!r)return f.default.createElement(k,null)
var u=i||c&&c.cid,d=0!==a.length
return f.default.createElement(k,null,d&&f.default.createElement("div",{className:"comment-title"},"".concat(t," (").concat(a.length,")")),d&&f.default.createElement("div",{ref:this.setScrollRef,className:"comment-thread"},a.map(function(e,t){var a=l[e.cid]||[],n=t+1,r="marker"===s&&u===e.cid,i="marker"===s&&null!==u&&!r
...
]),_=function(){window.location.href="/signin?next=".concat(window.location.pathname)},x="/images/preview/no-comment@2x.png"},"3xoc":function(e,t,a){"use strict"
var n=a("TqRt")
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var R=r(a("J4zp")),i=r(a("lwsE")),o=r(a("W8MJ")),l=r(a("a1gu")),s=r(a("Nsbk")),c=r(a("PJYZ")),u=r(a("7W2i")),d=r(a("lSNA")),f=r(a("17x9")),L=n(a("q1tI")),j=r(a("DKAG")),A=r(a("foKU")),B=r(a("tBsX")),O=a("oose"),D=r(a("dYO+")),F=r(a("DdUa")),q=r(a("kJQk")),U=r(a("9ZUU")),W=r(a("TSYQ"))
a("fSKh")
...
return l.default.createElement(C,{className:t?"sub":""},n?l.default.createElement(_,null,l.default.createElement(p.TextEditComponent,{textEditStore:n,placeholder:v.preview.comment.comment_placeholder,minHeight:60,autoHeight:!0,multiline:!0}),l.default.createElement(x,null,l.default.createElement(c.Button,{onClick:r},v.preview.comment.cancelEdit),l.default.createElement(c.Button,{type:"primary",onClick:n.endEdit},v.preview.comment.updateEdit))):l.default.createElement(k,null,a.message))}
...
return l.default.createElement(T,{className:t?"sub":""},l.default.createElement(I,null,l.default.createElement("img",{src:a,width:24,height:24}),l.default.createElement("div",null,r&&l.default.createElement("span",{className:"index"},"#".concat(r)),l.default.createElement("span",{className:"name"},n))),l.default.createElement(M,null,i&&l.default.createElement(N,{onSelect:i,menuClassName:"comment-header-edit",iconName:"cog",text:v.preview.comment.modify_edit}),o&&l.default.createElement(N,{onSelect:o,
menuClassName:"comment-header-delete",iconName:"trash",text:v.preview.comment.modify_delete})))}var C=s.default.div.withConfig({displayName:"CommentLayerThreadContent__ContentMessageDiv",componentId:"sc-1lkzl71-3"})(["display:flex;flex-flow:column;width:100%;height:auto;color:#5b6b73;white-space:nowrap;text-overflow:ellipsis;span{padding:10px;}&.sub span{padding:0 10px 10px;}"]),k=s.default.span.withConfig({displayName:"CommentLayerThreadContent__EditableSpanSpan",componentId:"sc-1lkzl71-4"})([
"user-select:text;word-break:break-all;white-space:pre-line;text-overflow:ellipsis;"]),_=s.default.div.withConfig({displayName:"CommentLayerThreadContent__EditableSpanDiv",componentId:"sc-1lkzl71-5"})(["background:#fff;> textarea{margin-bottom:5px;padding:10px;border:1px solid #d3dce6;}"]),x=s.default.div.withConfig({displayName:"CommentLayerThreadContent__ButtonPanelDiv",componentId:"sc-1lkzl71-6"})([
...
var s=r
t.default=s},"7bO/":function(e,t,a){"use strict"
a.r(t)
var n={}
a.r(n),a.d(n,"TASK",function(){return Y.e}),a.d(n,"SAGA_ACTION",function(){return Y.c}),a.d(n,"noop",function(){return Y.u}),a.d(n,"is",function(){return Y.q}),a.d(n,"deferred",function(){return Y.l}),a.d(n,"arrayOfDeffered",function(){return Y.g}),a.d(n,"createMockTask",function(){return Y.j}),a.d(n,"cloneableGenerator",function(){return Y.i}),a.d(n,"asEffect",function(){return X.d}),a.d(n,"CHANNEL_END",function(){return K})
var Y=a("Ev6p"),z=a("92lH"),V=a("udQi"),X=a("tw9P"),J=a("mbVZ"),Z=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t]
for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e},r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e}
var G="proc first argument (Saga function result) must be an iterator",K={toString:function(){return"@@redux-saga/CHANNEL_END"}},Q={toString:function(){return"@@redux-saga/TASK_CANCEL"}},i={wildcard:function(){return Y.r},default:function(t){return"symbol"===(void 0===t?"undefined":r(t))?function(e){return e.type===t}:function(e){return e.type===String(t)}},array:function(e){return function(t){return e.some(function(e){return $(e)(t)})}},predicate:function(t){return function(e){return t(e)}}}
...
function te(n,e,t,a,r,i,o,l,s){var u=1<arguments.length&&void 0!==e?e:function(){return Y.u},d=2<arguments.length&&void 0!==t?t:Y.u,f=3<arguments.length&&void 0!==a?a:Y.u,c=4<arguments.length&&void 0!==r?r:{},p=5<arguments.length&&void 0!==i?i:{},h=6<arguments.length&&void 0!==o?o:0,m=7<arguments.length&&void 0!==l?l:"anonymous",v=s
Object(Y.h)(n,Y.q.iterator,G)
...
!t&&e.stack&&(t=-1!==e.stack.split("\n")[0].indexOf(e.message)?e.stack:"Error: "+e.message+"\n"+e.stack),E("error","uncaught at "+m,t||e.message||e)},k=Object(z.f)(u),_=Object.create(c)
O.cancel=Y.u
var x,T,M,P,I,N,R,L=(x=h,T=m,P=v,(M=n)._deferredEnd=null,(N={})[Y.e]=!0,N.id=x,N.name=T,(R={})[I="done"]=R[I]||{},R[I].get=function(){if(M._deferredEnd)return M._deferredEnd.promise
var e=Object(Y.l)()
return M._deferredEnd=e,M._isRunning||(M._error?e.reject(M._error):e.resolve(M._result)),e.promise},N.cont=P,N.joiners=[],N.cancel=B,N.isRunning=function(){return M._isRunning},N.isCancelled=function(){return M._isCancelled},N.isAborted=function(){return M._isAborted},N.result=function(){return M._result},N.error=function(){return M._error},N.setContext=function(e){Object(Y.h)(e,Y.q.object,Object(Y.k)("task",e)),Y.v.assign(_,e)},function(e,t){for(var a in t){var n=t[a]
n.configurable=n.enumerable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,a,n)}}(N,R),N),j={name:m,cancel:function(){j.isRunning&&!j.isCancelled&&(j.isCancelled=!0,O(Q))},isRunning:!0},A=function(e,n,r){var i=[],o=void 0,l=!1
function s(e){a(),r(e,!0)}function t(a){i.push(a),a.cont=function(e,t){l||(Object(Y.w)(i,a),a.cont=Y.u,t?s(e):(a===n&&(o=e),i.length||(l=!0,r(o))))}}function a(){l||(l=!0,i.forEach(function(e){e.cont=Y.u,e.cancel()}),i=[])}return t(n),{addTask:t,cancelAll:a,abort:s,getTasks:function(){return i},taskNames:function(){return i.map(function(e){return e.name})}}}(0,j,D)
function B(){n._isRunning&&!n._isCancelled&&(n._isCancelled=!0,A.cancelAll(),D(Q))}return v&&(v.cancel=B),n._isRunning=!0,O(),L
function O(e,t){if(!j.isRunning)throw new Error("Trying to resume an already finished generator")
try{var a=void 0;(a=t?n.throw(e):e===Q?(j.isCancelled=!0,O.cancel(),Y.q.func(n.return)?n.return(Q):{done:!0,value:Q}):e===K?Y.q.func(n.return)?n.return():{done:!0}:n.next(e)).done?(j.isMainRunning=!1,j.cont&&j.cont(a.value)):F(a.value,h,"",O)}catch(e){j.isCancelled&&C(e),j.isMainRunning=!1,j.cont(e,!0)}}function D(t,a){n._isRunning=!1,k.close(),a?(t instanceof Error&&Object.defineProperty(t,"sagaStack",{value:"at "+m+" \n "+(t.sagaStack||t.stack),configurable:!0}),L.cont||(t instanceof Error&&w?w(t):C(t)),
n._error=t,n._isAborted=!0,n._deferredEnd&&n._deferredEnd.reject(t)):(n._result=t,n._deferredEnd&&n._deferredEnd.resolve(t)),L.cont&&L.cont(t,a),L.joiners.forEach(function(e){return e.cb(t,a)}),L.joiners=null}function F(e,t,a,n){var r=2<arguments.length&&void 0!==a?a:"",i=n,o=Object(Y.y)()
b&&b.effectTriggered({effectId:o,parentEffectId:t,label:r,effect:e})
var l=void 0
function s(e,t){l||(l=!0,i.cancel=Y.u,b&&(t?b.effectRejected(o,e):b.effectResolved(o,e)),i(e,t))}s.cancel=Y.u,i.cancel=function(){if(!l){l=!0
try{s.cancel()}catch(e){C(e)}s.cancel=Y.u,b&&b.effectCancelled(o)}}
var c=void 0
return Y.q.promise(e)?q(e,s):Y.q.helper(e)?W(ee(e),o,s):Y.q.iterator(e)?U(e,o,m,s):Y.q.array(e)?y(e,o,s):(c=X.d.take(e))?function(e,t){var a=e.channel,n=e.pattern,r=e.maybe
a=a||k
function i(e){return e instanceof Error?t(e,!0):Object(z.e)(e)&&!r?t(K):t(e)}try{a.take(i,$(n))}catch(e){return t(e,!0)}t.cancel=i.cancel}(c,s):(c=X.d.put(e))?function(e,t){var a=e.channel,n=e.action,r=e.resolve
Object(V.a)(function(){var e=void 0
try{e=(a?a.put:d)(n)}catch(e){if(a||r)return t(e,!0)
C(e)}if(!r||!Y.q.promise(e))return t(e)
q(e,t)})}(c,s):(c=X.d.all(e))?H(c,o,s):(c=X.d.race(e))?function(i,t,o){var l=void 0,s=Object.keys(i),a={}
s.forEach(function(r){function e(e,t){if(!l)if(t)o.cancel(),o(e,!0)
else if(!Object(z.e)(e)&&e!==K&&e!==Q){var a
o.cancel(),l=!0
var n=((a={})[r]=e,a)
o(Y.q.array(i)?[].slice.call(Z({},n,{length:s.length})):n)}}e.cancel=Y.u,a[r]=e}),o.cancel=function(){l||(l=!0,s.forEach(function(e){return a[e].cancel()}))},s.forEach(function(e){l||F(i[e],t,e,a[e])})}(c,o,s):(c=X.d.call(e))?function(e,t,a){var n=e.context,r=e.fn,i=e.args,o=void 0
try{o=r.apply(n,i)}catch(e){return a(e,!0)}return Y.q.promise(o)?q(o,a):Y.q.iterator(o)?U(o,t,r.name,a):a(o)}(c,o,s):(c=X.d.cps(e))?function(e,a){var t=e.context,n=e.fn,r=e.args
try{var i=function(e,t){return Y.q.undef(e)?a(t):a(e,!0)}
n.apply(t,r.concat(i)),i.cancel&&(a.cancel=function(){return i.cancel()})}catch(e){return a(e,!0)}}(c,s):(c=X.d.fork(e))?W(c,o,s):(c=X.d.join(e))?function(e,t){if(e.isRunning()){var a={task:L,cb:t}
t.cancel=function(){return Object(Y.w)(e.joiners,a)},e.joiners.push(a)}else e.isAborted()?t(e.error(),!0):t(e.result())}(c,s):(c=X.d.cancel(e))?function(e,t){e===Y.d&&(e=L)
e.isRunning()&&e.cancel()
t()}(c,s):(c=X.d.select(e))?function(e,t){var a=e.selector,n=e.args
try{var r=a.apply(void 0,[f()].concat(n))
t(r)}catch(e){t(e,!0)}}(c,s):(c=X.d.actionChannel(e))?function(e,t){var a=e.pattern,n=e.buffer,r=$(a)
r.pattern=a,t(Object(z.d)(u,n||J.a.fixed(),r))}(c,s):(c=X.d.flush(e))?function(e,t){e.flush(t)}(c,s):(c=X.d.cancelled(e))?function(e,t){t(!!j.isCancelled)}(0,s):(c=X.d.getContext(e))?function(e,t){t(_[e])}(c,s):(c=X.d.setContext(e))?function(e,t){Y.v.assign(_,e),t()}(c,s):s(e)}function q(e,t){var a=e[Y.a]
Y.q.func(a)?t.cancel=a:Y.q.func(e.abort)&&(t.cancel=function(){return e.abort()}),e.then(t,function(e){return t(e,!0)})}function U(e,t,a,n){te(e,u,d,f,_,p,t,a,n)}function W(e,t,a){var n=e.context,r=e.fn,i=e.args,o=e.detached,l=function(e){var t=e.context,a=e.fn,n=e.args
if(Y.q.iterator(a))return a
var r,i,o=void 0,l=void 0
try{o=a.apply(t,n)}catch(e){l=e}return Y.q.iterator(o)?o:l?Object(Y.t)(function(){throw l}):Object(Y.t)((r=void 0,i={done:!1,value:o},function(e){return r?function(e){return{done:!0,value:e}}(e):(r=!0,i)}))}({context:n,fn:r,args:i})
try{Object(V.c)()
var s=te(l,u,d,f,_,p,t,r.name,o?null:Y.u)
o?a(s):l._isRunning?(A.addTask(s),a(s)):l._error?A.abort(l._error):a(s)}finally{Object(V.b)()}}function H(n,t,r){var i=Object.keys(n)
if(!i.length)return r(Y.q.array(n)?[]:{})
var o=0,l=void 0,s={},c={}
i.forEach(function(a){function e(e,t){l||(t||Object(z.e)(e)||e===K||e===Q?(r.cancel(),r(e,t)):(s[a]=e,++o===i.length&&(l=!0,r(Y.q.array(n)?Y.f.from(Z({},s,{length:i.length})):s))))}e.cancel=Y.u,c[a]=e}),r.cancel=function(){l||(l=!0,i.forEach(function(e){return c[e].cancel()}))},i.forEach(function(e){return F(n[e],t,e,c[e])})}}var v="runSaga(storeInterface, saga, ...args): saga argument must be a Generator function!"
function u(e,t){for(var a=arguments.length,n=Array(2<a?a-2:0),r=2;r<a;r++)n[r-2]=arguments[r]
var i=void 0
Y.q.iterator(e)?(i=e,e=t):(Object(Y.h)(t,Y.q.func,v),i=t.apply(void 0,n),Object(Y.h)(i,Y.q.iterator,v))
var o=e,l=o.subscribe,s=o.dispatch,c=o.getState,u=o.context,d=o.sagaMonitor,f=o.logger,p=o.onError,h=Object(Y.y)()
...
var m=te(i,l,Object(Y.A)(s),c,u,{sagaMonitor:d,logger:f,onError:p},h,t.name)
return d&&d.effectResolved(h,m),m}var o=a("q09E"),l=a("oZtI")
a.d(t,"runSaga",function(){return u}),a.d(t,"END",function(){return z.a}),a.d(t,"eventChannel",function(){return z.d}),a.d(t,"channel",function(){return z.b}),a.d(t,"buffers",function(){return J.a}),a.d(t,"takeEvery",function(){return o.a}),a.d(t,"takeLatest",function(){return o.c}),a.d(t,"throttle",function(){return o.e}),a.d(t,"delay",function(){return Y.m}),a.d(t,"CANCEL",function(){return Y.a}),a.d(t,"detach",function(){return X.i}),a.d(t,"effects",function(){return l}),a.d(t,"utils",function(){return n
})
t.default=function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t=e.context,r=void 0===t?{}:t,i=function(e,t){var a={}
for(var n in e)0<=t.indexOf(n)||Object.prototype.hasOwnProperty.call(e,n)&&(a[n]=e[n])
return a}(e,["context"]),o=i.sagaMonitor,l=i.logger,s=i.onError
...
if(s&&!Y.q.func(s))throw new Error("`options.onError` passed to the Saga middleware is not a function!")
if(i.emitter&&!Y.q.func(i.emitter))throw new Error("`options.emitter` passed to the Saga middleware is not a function!")
function c(e){var t=e.getState,a=e.dispatch,n=Object(z.c)()
return n.emit=(i.emitter||Y.o)(n.emit),c.run=u.bind(null,{context:r,subscribe:n.subscribe,dispatch:a,getState:t,sagaMonitor:o,logger:l,onError:s}),function(a){return function(e){o&&o.actionDispatched&&o.actionDispatched(e)
var t=a(e)
return n.emit(e),t}}}return c.run=function(){throw new Error("Before running a Saga, you must mount the Saga middleware on the Store using applyMiddleware")},c.setContext=function(e){Object(Y.h)(e,Y.q.object,Object(Y.k)("sagaMiddleware",e)),Y.v.assign(r,e)},c}},"7bR1":function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.setVisibilityScreen=v,t.default=k
var c=n(a("o0o1")),y=n(a("MVZn")),r=n(a("J2m7")),u=a("oZtI"),d=a("upRB"),f=a("JfQ8"),s=a("Kkl0"),b=a("jvRN"),p=a("7q5O"),h=c.default.mark(v),i=c.default.mark(g),m=c.default.mark(w),o=c.default.mark(E),l=c.default.mark(k),S=[]
...
case 3:return n=e.sent,r=n.container.layers,i=r.resourceByScreen,o=r.visibilityScreenID,l=C(i[o].layers,a),e.next=9,(0,u.put)((0,s.selectLayer)(l))
...
case 2:case"end":return e.stop()}},o)}var C=function(e,t){var a=(0,r.default)(e,{id:t})
...
a=n.parent}}
function k(){return c.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,[g(),E()]
...
u.setState({glassLeft:s,glassTop:c}),l<0&&u.clearGlassRect(),u.glassCtx.clearRect(0,0,n,a),r<1&&console.warn("Can't make the galss scale less than 1, It will make bed invision"),k(u.glassCtx,!1),u.glassCtx.drawImage(u.imageCanvas,Math.floor(o-n/2/u.finallyScale),Math.floor(l-a/2/u.finallyScale),Math.floor(n/u.finallyScale),Math.floor(a/u.finallyScale),-5,-5,n,a),C(u.glassCtx,"lightgray",10,10),_(u.glassCtx),x(u.glassCtx,"black",Math.floor((n-10)/2),Math.floor((a-10)/2),10,10),u.getColor()}),(0,f.default)((0
...
return 1===t.length?"0".concat(t):t},C=function(e,t,a,n){e.strokeStyle=t,e.lineWidth=.5
for(var r=a+5.5;r<e.canvas.width-a;r+=a)e.beginPath(),e.moveTo(r,0),e.lineTo(r,e.canvas.height),e.stroke()
for(var i=n+5.5;i<e.canvas.height-a;i+=n)e.beginPath(),e.moveTo(0,i),e.lineTo(e.canvas.width,i),e.stroke()},k=function(e,t){e.mozImageSmoothingEnabled=t,e.webkitImageSmoothingEnabled=t,e.msImageSmoothingEnabled=t,e.imageSmoothingEnabled=t},_=function(e){e.beginPath(),e.strokeStyle="#8D9EA7",e.lineWidth=8,e.arc(100,100,96,0,2*Math.PI),e.stroke(),e.strokeStyle="#D4D7DC",e.lineWidth=5,e.arc(100,100,96,0,2*Math.PI),e.stroke()},x=function(e,t,a,n,r,i){e.beginPath(),a+=.5,n+=.5,e.strokeStyle=t,e.lineWidth=1,
...
this.props.unit!==t&&t===C&&this.updateSubToolbar({ratio:1})}},{key:"render",value:function(){var e=this.props,t=e.unit,a=e.emPixel,n=e.ratio,r=e.language,i=e.isShowColorPicker,o=e.colorUnit,l=e.isLogin,s=this.state.customEmPixel,c=t===_||t===k,u=t===C,d=t===_?I:P,f=[{value:10,label:"10px"},{value:12,label:"12px"},{value:14,label:"14px"},{value:16,label:"16px"},{value:a,label:"".concat(a,"px")},p.default.createElement("div",{onClick:function(e){return e.stopPropagation()}},p.default.createElement(
...
p.default.createElement(y.default,{name:"tube",type:"dora",onClick:this.pickColor}))),p.default.createElement("div",{className:"param"},p.default.createElement(g.default,{className:"color-unit",menuClassName:"PreviewSubToolbarSelectMenu",value:o,optionList:M,onChange:this.updateColorUnit}),p.default.createElement(g.default,{menuClassName:"PreviewSubToolbarSelectMenu",placeholder:" ",optionList:T,value:r,onChange:this.updateLanguage}),p.default.createElement(g.default,{className:"device-unit",
...
return Panel.all().forEach(function(e){e.screen_cid===t&&(e.multi_states?n[e.cid]=k(e):a[e.cid]=C(e))}),Screen.find(t).setState("default",!0),{cid:t,stateCid:"default",panelInfoMap:a,chameleonInfoMap:n}}var d=n(a("QILm")),y=n(a("MVZn")),b=n(a("RIqP")),S=n(a("lSNA")),w=a("upRB"),E=a("RKRO"),C=function(e){var t=e.mainState().cid
return{cid:e.cid,activeScreenCid:t,panelScreens:[t]}},k=function(e,t){var a=e.ct().homeScreen(),n=e.mainState().cid
...
t.cid=e.cid,t.screen_cid=f.cid,t.multi_states=e.multi_states,t.template_cid=e.template_cid,t.multi_states?g[e.cid]=k(t,l):v[e.cid]=C(t)}),n({type:"entry:runner:update:screen",payload:{screenCid:i,stateCid:o,panelInfoMap:v,chameleonInfoMap:g,transition:m}})}},"entry:runner:back-to-prev-page":function(e,t){var a=e.getState,n=e.dispatch,r=t.payload,i=void 0===r?{}:r,o=a(),l=(0,w.getRunnerState)(o),s=l.history,c=l.transition,u=c.name,d=c.duration,f=c.offset
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(a("MVZn")),o=r(a("lwsE")),l=r(a("W8MJ")),s=r(a("a1gu")),c=r(a("Nsbk")),u=r(a("PJYZ")),d=r(a("7W2i")),f=r(a("lSNA")),p=r(a("17x9")),h=n(a("q1tI")),m=a("6XO9"),v=a("wYtL"),g=(r(a("JSCU")),a("h0FN")),y=r(a("zy85")),b=r(a("UbMB")).default.bind(y.default),S={type:0,name:"自定义链接",target_cid:"screen-cid-1",transition:{name:"slide-left",duration:2e3}},w=[{value:1,label:"screen-link"},{value:2,label:"state-link"},{value:3,label:"panel-link"},{value:4,label:"widget-link"}],E=Link.TYPE,C=E.screen_link,
k=E.state_link,_=E.panel_link,x=E.widget_link,T=function(e){function a(){var t
...
var M=function(e){switch(e.type){case C:return h.default.createElement(P,{link:e})
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var s=r(a("o0o1")),i=r(a("yXPU")),o=r(a("lwsE")),l=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("PJYZ")),f=r(a("7W2i")),p=r(a("lSNA")),m=n(a("q1tI")),h=r(a("17x9")),v=a("DqDi"),g=a("i6OX"),y=r(a("4QcC")),b=r(a("Ur7v")),S=r(a("lCKy")),w=r(a("iX79")),E=a("/5+U"),C=a("1iCU"),k=a("t3Un"),_=a("2EV6"),x=a("Gbs1"),T=a("6x+O"),M=a("/5+U"),P=r(a("rtgd")),I=r(a("UbMB")).default.bind(P.default),N=[{label:I18N.preview.preview,icon:m.default.createElement(g.SVGIcon,{name:"design/preview"})},{
label:I18N.preview_panel.developer_mode,icon:m.default.createElement(g.SVGIcon,{name:"design/inspect"})},{label:I18N.preview_panel.comment,icon:m.default.createElement(g.SVGIcon,{name:"design/comment"})}],R=N.slice(0,2),L=function(e){function i(){var e,n;(0,o.default)(this,i)
for(var t=arguments.length,a=new Array(t),r=0;r<t;r++)a[r]=arguments[r]
return n=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(a))),(0,p.default)((0,d.default)(n),"setElementRef",function(e){return n.$elem=e}),(0,p.default)((0,d.default)(n),"handleTabChange",function(e){var t=n.props.dispatch,a=C.PREVIEW_CONFIG[e]
t({type:"entry:preview:select",payload:{toolbarActiveItem:C.PREVIEW_CONFIG[e]}}),MB.event("preview","".concat(C.TOOLBAR_TRAKING_CONFIG[a]))}),(0,p.default)((0,d.default)(n),"handTooltip",function(){$(n.$elem).tooltip({container:"body",selector:".project-name",placement:"right",trigger:"hover",title:function(e,t,a){var n=this.offsetWidth,r=this.scrollWidth,i=this.textContent
...
var j=function(){(0,M.canBackToWorkspace)()&&MB.designer.backDesign()},A=function(){var t=(0,i.default)(s.default.mark(function e(a){var n,r,i,o,l
...
e.next=16
break
case 5:return e.next=7,t=a,(0,k.requestJSON)(t,null,{method:"POST"})
...
return p.default.createElement("div",{key:e.cid,"data-cid":e.cid,"data-link_cid":n,id:"widget".concat(e.cid,"p"),className:t,style:a,onClick:this.handleClick},(0,h.getWidgetContent)(e))}}]),i}(p.PureComponent);(0,f.default)(g,"propTypes",{sticky:i.default.object})},I19b:function(e,t,a){},IV71:function(e,t,a){"use strict"
var n=a("TqRt")
...
t.STYLE_MAP=void 0
t.STYLE_MAP={design:{distanceMarks:{showStartAndEndBoundary:!1,dashed:!1,colorForLines:"#eb5648",colorForText:"#eb5648"},refRectBorder:{dashed:!1,colorForLines:"#eb5648"},verboseAuxiliaryLines:!1,auxiliaryLines:{dashed:!(t.STYLE_MAP=void 0),colorForLines:"#eb5648"}},preview:{distanceMarks:{showStartAndEndBoundary:!0,dashed:!0,colorForLines:"#ff7100"},refRectBorder:{dashed:!0,colorForLines:"#1e98ea"},verboseAuxiliaryLines:!0,auxiliaryLines:{dashed:!0,colorForLines:"#1e98ea"}}}},Ij3M:function(e,t,a){
"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.ColorInfo=void 0
var i=r(a("lwsE")),o=r(a("W8MJ")),l=r(a("a1gu")),s=r(a("Nsbk")),c=r(a("PJYZ")),u=r(a("7W2i")),d=r(a("lSNA")),f=n(a("q1tI")),p=r(a("17x9")),h=a("wYtL"),m=a("XrEr"),v=r(a("UbMB")),g=r(a("mfFm")),y=v.default.bind(g.default),b=function(e){function a(e){var t
return(0,i.default)(this,a),t=(0,l.default)(this,(0,s.default)(a).call(this,e)),(0,d.default)((0,c.default)(t),"handleClick",function(){t.setState(function(e){return{activeColor:e.colorList[e.index%4],index:e.index+1}})}),t.state={index:0,activeColor:e.stateColor,colorList:"transparent"===e.rgbaColor?Array(4).fill("transparent"):S(e.rgbaColor)||[]},t}return(0,u.default)(a,e),(0,o.default)(a,[{key:"UNSAFE_componentWillReceiveProps",value:function(e){var t=e.stateColor
this.setState(function(e){return{activeColor:t}})}},{key:"render",value:function(){var e=this.state.activeColor,t=this.props,a=t.title,n=t.rgbaColor,r=y("panel","panel-bottom-8"),i=n.split(","),o=i.length,l=3<o&&1!=+i[o-1].replace(")","")
return f.default.createElement("div",{className:r,"data-value":a},f.default.createElement("div",{className:"panel-item panel-item-color item-flex-1"},f.default.createElement(h.Tooltip,{className:"panel-item-value textEllipsis",content:{click:I18N.preview_panel.copied},"data-type":"copy",arrowed:!1,"data-clipboard-text":e},e),f.default.createElement("div",{className:"panel-item-color-block-wrap ".concat(l?"panel-item-color-block-imageback-wrap":"")},f.default.createElement("div",{
className:"panel-item-color-block",style:{backgroundColor:n},onClick:this.handleClick}))))}}]),a}(f.PureComponent)
t.ColorInfo=b
...
b.propTypes={rgbaColor:p.default.string.isRequired,stateColor:p.default.string,title:p.default.string}},Iusu:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.Base=void 0
function r(e){var t=e.title,a=e.dataValue,n=void 0===a?[]:a,r=e.data,i=void 0===r?[]:r,o=e.text,l=e.color,s=e.className,c=e.colorUnit,u=e.first,d=(0,b.getColorFromUnit)(l,"rgba"),f=(0,b.getColorFromUnit)(l,c),p=0<n.length,h=4===n.length,m=S("panel","".concat(s),{"panel-bottom-8":!p,"panel-item-text":!!o,"shadow-panel":h})
...
i.length<2?"single-panel-box":"mult-panel-box")},(u?i.slice(0,1):i).map(function(e,t){return v.default.createElement(g.Tooltip,{key:t,arrowed:!1,content:{click:I18N.preview_panel.copied},duration:1e3,className:"panel-item","data-value":n[t]},v.default.createElement("div",{"data-type":"copy","data-clipboard-text":e,className:"panel-item-value"},e))})))}var v=n(a("q1tI")),i=n(a("17x9")),g=a("wYtL"),y=a("RUem"),b=a("XrEr"),o=n(a("UbMB")),l=n(a("mfFm")),S=o.default.bind(l.default);(t.Base=r).propTypes={
title:i.default.string,data:i.default.array,dataValue:i.default.array,text:i.default.string,color:i.default.string,colorUnit:i.default.string,first:i.default.bool,className:i.default.string}},J2m7:function(e,t,a){var n=a("XKAG")(a("UfWW"))
...
LVRM:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.BasicAttributes=void 0
function r(e){var t=e.adapterLeft,a=e.adapterTop,n=e.adapterWidth,r=e.adapterHeight,i=e.opacity,o=e.radius,l=e.rotate
return s.default.createElement(c.WrapComponent,null,I18N.preview_panel.basic_attribute,t&&s.default.createElement(c.Base,{title:I18N.preview_panel.position,dataValue:[I18N.preview_panel._x,I18N.preview_panel._y],data:[t,a]}),n&&s.default.createElement(c.Base,{title:I18N.preview_panel.size,dataValue:[I18N.preview_panel.width,I18N.preview_panel.height],data:[n,r]}),l&&s.default.createElement(c.Base,{title:I18N.preview_panel.rotation,data:[l]}),o&&s.default.createElement(c.Base,{
title:I18N.preview_panel.border_radius,data:[o]}),i&&s.default.createElement(c.Base,{title:I18N.preview_panel.opacity,data:[i]}))}var s=n(a("q1tI")),i=n(a("17x9")),c=a("RUem");(t.BasicAttributes=r).propTypes={adapterLeft:i.default.string,adapterHeight:i.default.string,adapterTop:i.default.string,adapterWidth:i.default.string,opacity:i.default.oneOfType([i.default.string,i.default.bool]),rotate:i.default.oneOfType([i.default.string,i.default.bool]),radius:i.default.oneOfType([i.default.string,
i.default.number])}},LbTH:function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.checkIfItemTextIsNewVersion=void 0
t.checkIfItemTextIsNewVersion=function(e){return"rich_text"===e.name}},Lyer:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=v,(0,d.default)(v,"propTypes",{activeCid:p.default.string,screenTreeMap:p.default.object,screenDataMap:p.default.object,renderCommentIcon:p.default.func,dispatch:p.default.func})},MzIM:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var r=n(a("pVnL")),o=n(a("QILm")),l=n(a("lwsE")),s=n(a("W8MJ")),c=n(a("a1gu")),u=n(a("Nsbk")),d=n(a("PJYZ")),f=n(a("7W2i")),p=n(a("lSNA")),h=n(a("q1tI")),i=n(a("17x9")),m=a("6XO9"),v=function(e){function i(){var e,t;(0,l.default)(this,i)
for(var a=arguments.length,n=new Array(a),r=0;r<a;r++)n[r]=arguments[r]
return t=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(t),"handleChange",function(e){return t.props.onChange(e,t.props.attr)}),t}return(0,f.default)(i,e),(0,s.default)(i,[{key:"render",value:function(){var e=this.props,t=e.forwardedRef,a=(e.attr,e.size),n=(e.onChange,(0,o.default)(e,["forwardedRef","attr","size","onChange"]))
return h.default.createElement(m.Select,(0,r.default)({},n,{ref:t,size:a,onChange:this.handleChange}))}}]),i}(h.default.PureComponent);(0,p.default)(v,"propTypes",{forwardedRef:i.default.object,attr:i.default.string,size:i.default.oneOf(["regular","small"]),onChange:i.default.func}),(0,p.default)(v,"defaultProps",{size:"small"})
var g=h.default.forwardRef(function(e,t){return h.default.createElement(v,(0,r.default)({forwardedRef:t},e))})
t.default=g},NcbO:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var c=r(a("pVnL")),i=r(a("lwsE")),o=r(a("W8MJ")),l=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("PJYZ")),s=r(a("7W2i")),f=r(a("lSNA")),p=r(a("o0o1")),h=r(a("yXPU")),m=a("17x9"),v=n(a("q1tI")),g=a("i6OX"),y=a("t3Un"),b=a("rbsZ"),S=r(a("PeD6")),w=r(a("KUpD")),E=r(a("UbMB")).default.bind(w.default),C=function(){var t=(0,h.default)(p.default.mark(function e(t){var a,n,r
...
return function(e){return t.apply(this,arguments)}}(),k=function(t){return new Promise(function(e){return setTimeout(e,t)})},_=function(e){function t(){var s
...
t.degreeToRadians=x
function I(e,t){var a=(0,P.default)(e,2),n=a[0],r=a[1],i=x(t)
return[Math.cos(i)*n+Math.sin(i)*r,-Math.sin(i)*n+Math.cos(i)*r]}t.getVectorInOtherSystem=I
t.getLineAttrsAfterUngroup=function(e,t,a,n){var r=(0,P.default)(e,2),i=r[0],o=r[1],l=(0,P.default)(t,2),s=l[0],c=l[1],u=n.top,d=n.left,f=n.width,p=n.height,h=n.points,m=JSON.parse(h).map(function(e){return e.point}),v=(0,P.default)(m,2),g=(0,P.default)(v[0],2),y=g[0],b=g[1],S=(0,P.default)(v[1],2),w=S[0],E=S[1],C=[d-s,u-c],k=[C[0]+w*f,C[1]+E*p],_=I([C[0]+y*f,C[1]+b*p],-a),x=I(k,-a),T=[i+_[0],o+_[1]],M=[i+x[0],o+x[1]]
return N(T,M)}
...
return.5===n&&.5===o||.5===r&&.5===l}},QIyF:function(e,t,a){var n=a("Kz5y")
e.exports=function(){return n.Date.now()}},QdB0:function(e,t,a){"use strict"
var n=a("TqRt")
...
var r=n(a("ThAd")),i={info:{name:"lisankebook",desc:"李三科送给你的专属福利，现在注册墨刀即可享受一个月个人版会员",successTip:"注册成功，恭喜你获得墨刀一个月个人版会员"},checker:function(){return(0,r.default)().utm_source===i.info.name}},o=[i]},QlAn:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.GlobalAttributes=void 0
function o(){return h.default.createElement("div",null,"Error in GlobalAttributes")}var l=r(a("lwsE")),s=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("PJYZ")),f=r(a("7W2i")),p=r(a("lSNA")),h=n(a("q1tI")),i=a("/MKj"),m=r(a("17x9")),v=a("6XO9"),g=a("wYtL"),y=r(a("i6OX")),b=a("RUem"),S=a("XrEr"),w=a("/5+U"),E=r(a("mfFm")),C=r(a("UbMB")).default.bind(E.default),k=function(e){function i(){var e,a;(0,l.default)(this,i)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return a=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(a),"handleDelColor",function(e){var t=(0,w.delRecentColor)((0,S.getColorFromUnit)(e,"rgba"))
a.props.dispatch({type:"reducer:preview-toolbar:update",payload:{userPickColor:t}}),MB.event("preview","删除了自选颜色")}),(0,p.default)((0,d.default)(a),"handleClick",function(e){var t=e.target.dataset.trackId
t&&MB.event("preview","标注模式: 复制".concat(t))}),a}return(0,f.default)(i,e),(0,s.default)(i,[{key:"componentDidCatch",value:function(e,t){return console.log(e,t),h.default.createElement(o,null)}},{key:"render",value:function(){var e=this.props,t=e.adapterWidth,a=e.adapterHeight,n=e.screenColor,r=void 0===n?[]:n,i=e.documentColor,o=void 0===i?[]:i,l=e.globalText,s=void 0===l?[]:l,c=e.globalColor,u=void 0===c?[]:c,d=e.userPickColor,f=void 0===d?[]:d,p=e.colorUnit
o.concat(u)
return h.default.createElement("div",{className:C("global-attributes"),onClick:this.handleClick},h.default.createElement("div",{className:C("container","global-layer","layer-size")},h.default.createElement(b.Base,{trackId:"宽高",title:I18N.preview_panel.size,dataValue:[I18N.preview_panel.width,I18N.preview_panel.height],data:[t,a]})),h.default.createElement(b.WrapComponent,null,I18N.preview_panel.color_title,h.default.createElement(T,{trackId:"自选颜色",title:I18N.preview_panel.pick_color,
handleDelColor:this.handleDelColor,colorBlockMap:f,colorUnit:p,canDel:!0}),h.default.createElement(x,{trackId:"页面颜色",title:I18N.preview_panel.screen_color,handleDelColor:this.handleDelColor,colorBlockMap:r,colorUnit:p})),0<s.length&&h.default.createElement(b.WrapComponent,null,I18N.preview_panel.font_title,h.default.createElement(_,{globalText:s})))}}]),i}(h.PureComponent);(t.GlobalAttributes=k).propTypes={adapterWidth:m.default.string.isRequired,adapterHeight:m.default.string.isRequired,
...
var x=function(e){var r=e.trackId,t=e.title,a=e.colorBlockMap,i=e.fromSketch,o=e.handleDelColor,l=e.canDel,s=e.colorUnit,c=e.focusColor
return h.default.createElement("div",null,h.default.createElement("span",{className:"second-title"},t),h.default.createElement("div",{className:"panel-row"},a.length?a.map(function(e,t){var a=M(i,e,"rgba"),n=(0,S.getColorFromUnit)(a,s)
return h.default.createElement(P,{key:"".concat(t).concat(e),canDel:l,trackId:r,handleDelColor:o,color:n,rgbaColor:a,colorUnit:s,focusColor:c})}):h.default.createElement(I,null)))}
...
return{userPickColor:t.userPickColor,focusColor:t.focusColor}})(x),M=function(e,t,a){return(0,S.getColorFromUnit)(e?(0,S.parseSketchColor2rgba)(t):t,a)},P=function(e){var t=e.color,a=e.rgbaColor,n=e.colorUnit,r=e.handleDelColor,i=e.canDel,o=e.trackId,l=e.focusColor,s=t===(0,S.getColorFromUnit)(l,n)
return h.default.createElement(v.Dropdown,{shouldOpenOnHover:!0,className:C("color-dropdown",{"is-focus":s}),opener:h.default.createElement(g.Tooltip,{arrowed:!1,"data-type":"copy","data-track-id":o,"data-clipboard-text":t,className:"row-item color-block",style:{background:a},duration:1e3,content:{click:I18N.preview_panel.copied}}),inflexible:!0,arrowed:!0,menuX:"left",menuY:"top",menu:h.default.createElement(N,{color:t,rgbaColor:a,canDel:i,handleDelColor:r}),menuClassName:(0,v.trimList)([
"palette-dropdown-menu",n])})}
P.propTypes={color:m.default.string.isRequired,trackId:m.default.string,handleDelColor:m.default.func,colorUnit:m.default.string,rgbaColor:m.default.string,canDel:m.default.bool,focusColor:m.default.string}
var I=function(){return h.default.createElement("div",{className:"forbid-color"},h.default.createElement("div",{className:"transparent"}))},N=function(e){function i(){var e,n;(0,l.default)(this,i)
for(var t=arguments.length,a=new Array(t),r=0;r<t;r++)a[r]=arguments[r]
return n=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(a))),(0,p.default)((0,d.default)(n),"handleClick",function(e){var t=n.props,a=t.rgbaColor;(0,t.handleDelColor)(a)}),n}return(0,f.default)(i,e),(0,s.default)(i,[{key:"render",value:function(){var e=this.props,t=e.color,a=e.canDel
return h.default.createElement("div",null,h.default.createElement("span",null,t),a&&h.default.createElement(y.default,{type:"dora",name:"trash",className:"trash",onClick:this.handleClick}))}}]),i}(h.PureComponent)
N.propTypes={color:m.default.string.isRequired,rgbaColor:m.default.string,handleDelColor:m.default.func.isRequired,canDel:m.default.bool}},RUem:function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"Base",{enumerable:!0,get:function(){return n.Base}}),Object.defineProperty(t,"ColorInfo",{enumerable:!0,get:function(){return r.ColorInfo}}),Object.defineProperty(t,"TextLayerInfo",{enumerable:!0,get:function(){return i.TextLayerInfo}}),Object.defineProperty(t,"BasicAttributes",{enumerable:!0,get:function(){return o.BasicAttributes}}),Object.defineProperty(t,"GlobalAttributes",{enumerable:!0,get:function(){return l.GlobalAttributes}})
,Object.defineProperty(t,"CodeBox",{enumerable:!0,get:function(){return s.CodeBox}}),Object.defineProperty(t,"ImageInfo",{enumerable:!0,get:function(){return c.ImageInfo}}),Object.defineProperty(t,"CopyBtn",{enumerable:!0,get:function(){return u.CopyBtn}}),Object.defineProperty(t,"Shadows",{enumerable:!0,get:function(){return d.Shadows}}),Object.defineProperty(t,"Fills",{enumerable:!0,get:function(){return d.Fills}}),Object.defineProperty(t,"LayerName",{enumerable:!0,get:function(){return d.LayerName}}),
...
var n=a("Iusu"),r=a("Ij3M"),i=a("wQP3"),o=a("LVRM"),l=a("QlAn"),s=a("bekf"),c=a("1Uxz"),u=a("h9XN"),d=a("WyLE")},Rm7n:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var r=n(a("pVnL")),o=n(a("QILm")),l=n(a("lwsE")),s=n(a("W8MJ")),c=n(a("a1gu")),u=n(a("Nsbk")),d=n(a("PJYZ")),f=n(a("7W2i")),p=n(a("lSNA")),h=n(a("q1tI")),i=n(a("17x9")),m=a("6XO9"),v=function(e){function i(){var e,n;(0,l.default)(this,i)
for(var t=arguments.length,a=new Array(t),r=0;r<t;r++)a[r]=arguments[r]
return n=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(a))),(0,p.default)((0,d.default)(n),"handleChange",function(e,t,a){return n.props.onChange(a,n.props.attr)}),n}return(0,f.default)(i,e),(0,s.default)(i,[{key:"render",value:function(){var e=this.props,t=(e.attr,e.size),a=(e.onChange,(0,o.default)(e,["attr","size","onChange"]))
return h.default.createElement(m.Check,(0,r.default)({},a,{size:t,onChange:this.handleChange}))}}]),i}(h.default.PureComponent);(t.default=v).propTypes={attr:i.default.string,size:i.default.oneOf(["regular","small"]),onChange:i.default.func},v.defaultProps={size:"small"}},Ro3d:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.transfromProptype=void 0
var O=n(a("lSNA")),i=a("XrEr"),D=a("qOCw")
t.transfromProptype=function(e){var t=e.attr,a=e.language,n=e.unit,r=(0,D.selectWithlanguageUnit)(a),i=t.width,o=t.height,l=t.lineHeight,s=t.opacity,c=t.borderRadius,u=t.borderWidth,d=t.borderColor,f=t.backgroundColor,p=t.color,h=t.fontSize,m=t.fontFamily,v=t.fontStyle,g=t.boxShadow,y=t.textAlign,b=t.x,S=t.y,w=b&&(0,O.default)({},q[r].x,F(b,n,r)),E=S&&(0,O.default)({},q[r].y,F(S,n,r)),C=i&&(0,O.default)({},q[r].width,F(i,n,r)),k=o&&(0,O.default)({},q[r].height,F(o,n,r)),_=l&&(0,O.default)({},q[r].lineHeight
,F(l,n,r)),x=s&&(0,O.default)({},q[r].opacity,F(s,n,r)),T=c&&(0,O.default)({},q[r].borderRadius,F(c,n,r)),M=f&&(0,O.default)({},q[r].backgroundColor,F(f,n,r,!0)),P=p&&(0,O.default)({},q[r].color,F(p,n,r,!0)),I=h&&(0,O.default)({},q[r].fontSize,F(h,n,r)),N=m&&(0,O.default)({},q[r].fontFamily,F(m,n,r)),R=v&&(0,O.default)({},q[r].fontStyle,F(v,n,r)),L=g&&(0,O.default)({},q[r].shadows,g),j=u&&(0,O.default)({},q[r].borderWidth,F(u,n,r)),A=d&&(0,O.default)({},q[r].borderColor,F(d,n,r,!0)),B=y&&(0,O.default)({},
q[r].textAlign,y)
return Object.assign({},w,E,C,k,_,x,T,j,A,M,P,I,R,B,L,N)}
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var C=r(a("pVnL")),k=r(a("J4zp")),i=r(a("lwsE")),o=r(a("W8MJ")),l=r(a("a1gu")),s=r(a("Nsbk")),c=r(a("7W2i")),u=r(a("lSNA")),d=r(a("17x9")),_=n(a("q1tI")),x=r(a("vmbo")),T=a("/5+U"),f=function(e){function E(){return(0,i.default)(this,E),(0,l.default)(this,(0,s.default)(E).apply(this,arguments))}return(0,c.default)(E,e),(0,o.default)(E,[{key:"render",value:function(){var e=this.props,t=e.layer,a=e.parentRect,n=e.treeProps,r=t.width,i=t.height,o=t.top,l=t.left,s=t.z,c=t.childrenLayers
if(!1===t.v)return null
var u="layer"===t.kind?0:t.rotation||0,d=(0,T.getMinBoundingRect)({width:r,height:i,rotate:u,top:o,left:l}),f=(0,k.default)(d,4),p=f[0],h=f[1],m=f[2],v=f[3],g={top:o,left:l,width:r,height:i},y=h,b=m,S=v,w={top:(p-a.top)/a.height*100+"%",left:(y-a.left)/a.width*100+"%",width:b/a.width*100+"%",height:S/a.height*100+"%",zIndex:s||0}
return _.default.createElement("div",{"data-id":t.id,className:"layer-tree-node",style:w},_.default.createElement(x.default,(0,C.default)({layer:t},n)),c&&0<c.length&&c.map(function(e){return _.default.createElement(E,{key:e.id,layer:e,parentRect:g,treeProps:n})}))}}]),E}(_.Component)
...
case 15:case"end":return e.stop()}},e)}))
return function(e){return t.apply(this,arguments)}}()
t.requestSnapshotZipLocalhost=i},Sxd8:function(e,t){e.exports=function(e){return e}},TT1N:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.FormEntry=o,t.FormLabel=function(e){return l.default.createElement(o,(0,r.default)({},e,{isLabel:!0}))}
var r=n(a("pVnL")),l=n(a("q1tI")),i=n(a("17x9"))
function o(e){var t=e.className,a=e.name,n=e.children,r=e.type,i=e.isLabel,o=e.isRequired
return l.default.createElement(i?"label":"div",{className:"form-entry ".concat(t),type:r},a&&l.default.createElement("span",{className:"key"},a,o&&l.default.createElement("span",{className:"required-sign"},"*")),l.default.createElement("span",{className:"val"},n))}a("qY2g"),o.propTypes={className:i.default.string,children:i.default.any,name:i.default.any,type:i.default.string,isLabel:i.default.bool,isRequired:i.default.bool},o.defaultProps={className:"",isLabel:!1}},TZdj:function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function n(i,o){return c(function(e,t,a){var n=t.dispatch,r=a&&a.payload
...
return v.default.createElement(w,{ref:this.setRef,className:i?"comment-blur":"",onMouseEnter:this.focusThread,onMouseLeave:this.blurThread},v.default.createElement(C,{markIndex:n,comment:l,permission:a,commentOperations:r}),c.map(function(e){return v.default.createElement(C,{sub:!0,key:e.cid,comment:e,permission:r.getPermission(e.user_id),commentOperations:r})}),s&&v.default.createElement("div",{className:"unfold",onClick:this.toggleUnfoldComment},o?b.preview.comment.fold:b.preview.comment.unfold))}}]),a}(
v.PureComponent)
...
return v.default.createElement(k,{className:m},v.default.createElement(g.ContentHeader,{sub:t,avatar:d,name:f,markIndex:a,startEdit:!l&&r.update?this.startEdit:null,doDelete:!l&&r.delete?this.operationPack.doDeleteCard:null}),!t&&v.default.createElement(E,null,p,h),t&&p,t&&h)}}]),t}(v.PureComponent);(0,u.default)(C,"propTypes",{sub:d.default.bool,markIndex:d.default.number,comment:d.default.object.isRequired,permission:d.default.object.isRequired,commentOperations:d.default.object.isRequired})
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(a("pVnL")),o=r(a("MVZn")),l=r(a("o0o1")),s=r(a("yXPU")),c=r(a("lwsE")),u=r(a("W8MJ")),d=r(a("a1gu")),f=r(a("Nsbk")),p=r(a("PJYZ")),h=r(a("7W2i")),m=r(a("lSNA")),v=r(a("Znm+")),g=r(a("mwIZ")),y=n(a("q1tI")),b=r(a("17x9")),S=a("/MKj"),w=a("7Qib"),E=a("wYtL"),C=r(a("i6OX")),k=a("5vJs"),_=a("xoLq"),x=a("/5+U"),T=r(a("ztWx")),M=function(e){function t(){var a
return(0,c.default)(this,t),a=(0,d.default)(this,(0,f.default)(t).call(this)),(0,m.default)((0,p.default)(a),"handleShare",(0,s.default)(l.default.mark(function e(){return l.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:MB.isDashboard?MB.askDashboardToShare():a.setState({isSharingOverlayOpen:!0}),MB.event("preview","工具栏: 点击分享按钮"),MB.event("zhuge",(0,x.canBackToWorkspace)()?"Preview_click_share":"LinkPreview_click_share"),MB.event("zhuge","SharePopup_enter",{From:(0,x.canBackToWorkspace)(
)?"Preview":"Linkpreview"})
...
return y.default.createElement(y.Fragment,null,y.default.createElement(E.Tooltip,{position:"bottom",duration:1e3,content:{hover:I18N.preview.share},tipClassName:"marign-top-20"},y.default.createElement(C.default,{type:"dora",name:"share",className:"share-icon",onClick:this.handleShare})),e)}},{key:"data",get:function(){var e=(0,w.camelizeKeys)(MB.currentOrg),t=(0,w.camelizeKeys)(MB.currentTeam),a=(0,w.camelizeKeys)(MB.currentProject),n=MB.user,r=n.id,i=(0,g.default)(e,"cid","me"),o=a.expired
return e&&Object.assign(e,{policyPermissionMap:k.POLICY_PERMISSION_MAP}),{workspace:i,isExpired:o,org:e,team:t,app:a,me:n,meId:r}}},{key:"sharingOverlay",get:function(){var e=this.state.isSharingOverlayOpen,t=this.data
return!MB.isDashboard&&y.default.createElement(T.default,(0,i.default)({isOpen:e,onToggle:this.onToggleSharingOverlay,updateTeamFromProps:this.updateTeam,updateAppFromProps:this.updateApp},t,{withStore:!1}))}}]),t}(y.PureComponent);(0,m.default)(M,"propTypes",{checkPermissionStorelessly:b.default.func})
var P=(0,S.connect)(void 0,{checkPermissionStorelessly:_.checkPermissionStorelessly})(M)
...
return function(e,t){return a.apply(this,arguments)}}()
t.onFallbackError=h},VkAN:function(e,t){e.exports=function(e,t){return t=t||e.slice(0),Object.freeze(Object.defineProperties(e,{raw:{value:Object.freeze(t)}}))}},WcC0:function(e,t,a){},WyLE:function(e,t,a){"use strict"
var n=a("TqRt")
...
function r(e){var t=e.value,a=e.title
return y.default.createElement("div",{className:"".concat(s("container")," ").concat(s("layer-name"))},y.default.createElement(b.Base,{title:a||I18N.preview_panel.layer_name,data:[t]}))}var y=n(a("q1tI")),i=n(a("17x9")),b=a("RUem"),o=n(a("mfFm")),l=n(a("UbMB")),S=a("/5+U"),w=a("XrEr"),s=l.default.bind(o.default);(t.LayerName=r).propTypes={title:i.default.string,value:i.default.string}
function c(e){var c=e.colorUnit,t=e.backgroundColorSort
return y.default.createElement(h,null,I18N.preview_panel.fills,t.map(function(e,t){var a=e.value,n=e.type,r=void 0===n?"color":n,i=e.opacity,o=e.gradient,l=(0,w.getNormalRgbaColor)(a),s=l&&(0,w.getColorFromUnit)(l,c)
return"color"===r?y.default.createElement(b.ColorInfo,{stateColor:s,rgbaColor:l,title:I18N.preview_panel.color,key:t}):y.default.createElement(f,{gradient:o,colorUnit:c,opacity:i,key:t})}))}(t.Fills=c).propTypes={backgroundColorSort:i.default.array,colorUnit:i.default.string}
var f=function(e){var t=e.gradient,a=t.color_stops,n=void 0===a?[]:a,r=(t.from,t.to,t.type),i=e.opacity,o=e.colorUnit
return y.default.createElement("div",null,0<n.length&&n.map(function(e,t){var a=e.color
e.position
return y.default.createElement("div",{key:"".concat(a).concat(t)},y.default.createElement(b.Base,{colorUnit:o,color:(0,w.getNormalRgbaColor)(a),title:0==t?I18N.preview_panel.gradient:""}))}),i&&y.default.createElement(b.Base,{title:I18N.preview_panel.opacity,data:["".concat(100*i,"%")]}),r&&y.default.createElement(b.Base,{data:[r],title:I18N.preview_panel.type}))};(t.GradientColor=f).propTypes={gradient:i.default.object.isRequired,opacity:i.default.number,colorUnit:i.default.string.isRequired}
function u(e){var t=e.shadows,a=void 0===t?[]:t,n=e.isInnerShaow,r=void 0!==n&&n,i=e.unit,o=e.ratio,l=e.colorUnit,s=e.textShadows,c=void 0===s?[]:s
return y.default.createElement(h,null,r?I18N.preview_panel.inner_shadow:I18N.preview_panel.shadow,0<a.length&&y.default.createElement(d,{shadows:a,unit:i,ratio:o,colorUnit:l}),0<c.length&&y.default.createElement(d,{shadows:c,unit:i,ratio:o,colorUnit:l}))}(t.Shadows=u).propTypes={shadows:i.default.array,textShadows:i.default.array,isInnerShaow:i.default.bool,unit:i.default.string.isRequired,ratio:i.default.number.isRequired,colorUnit:i.default.string.isRequired}
var d=function(e){var t=e.shadows,m=e.unit,v=e.ratio,g=e.colorUnit
return t.map(function(e,t){var a=e.color,n=e.offset_x,r=void 0===n?0:n,i=e.offset_y,o=void 0===i?0:i,l=e.blur_radius,s=void 0===l?0:l,c=e.spread,u=void 0===c?0:c,d=(0,S.adapterScreen)(r,v,m),f=(0,S.adapterScreen)(o,v,m),p=(0,S.adapterScreen)(s,v,m),h=(0,S.adapterScreen)(u,v,m)
return y.default.createElement("div",{className:"shadow-item-gap",key:t},a&&y.default.createElement(b.Base,{title:I18N.preview_panel.color,color:(0,w.getNormalRgbaColor)(a),colorUnit:g}),y.default.createElement(b.Base,{data:[d,f,p,h],dataValue:[I18N.preview_panel._x,I18N.preview_panel._y,I18N.preview_panel.blur,I18N.preview_panel.spread]}))})}
d.propTypes={shadows:i.default.array,unit:i.default.string,ratio:i.default.number,colorUnit:i.default.string}
function p(e){var c=e.colorUnit,t=e.borderSort,u=e.unit,d=e.ratio,a=e.isStroke
return y.default.createElement(h,null,a?I18N.preview_panel.stroke:I18N.preview_panel.borders,t.reverse().map(function(e,t){var a=e.position,n=void 0===a?"inside":a,r=e.color,i=e.thickness,o=e.gradient,l=r&&(0,w.getNormalRgbaColor)(r),s=i&&(0,S.adapterScreen)(i,d,u)
return[r?y.default.createElement(b.Base,{key:"".concat(t).concat(l),color:l,title:I18N.preview_panel.color,colorUnit:c}):y.default.createElement(f,{gradient:o,colorUnit:c}),n&&y.default.createElement(b.Base,{key:"".concat(t).concat(n),title:I18N.preview_panel.position,data:[n]}),s&&y.default.createElement(b.Base,{key:"".concat(t).concat(s),title:I18N.preview_panel.thickness,data:[s]})]}))}(t.BorderInfo=p).propTypes={isStroke:i.default.bool,borderSort:i.default.array.isRequired,
colorUnit:i.default.string.isRequired,unit:i.default.string.isRequired,ratio:i.default.number.isRequired}
t.Loading=function(){return y.default.createElement("div",{className:s("layer-load")},y.default.createElement("span",{className:s("spinner")}))}
var h=function(e){var t=e.children
return y.default.createElement("section",null,y.default.createElement("div",{className:s("header")},t[0]),y.default.createElement("div",{className:s("container")},t.slice(1)))};(t.WrapComponent=h).propTypes={children:i.default.array}},XKAG:function(e,t,a){var l=a("ut/Y"),s=a("MMmD"),c=a("7GkX")
e.exports=function(o){return function(e,t,a){var n=Object(e)
if(!s(e)){var r=l(t,3)
e=c(e),t=function(e){return r(n[e],e,n)}}var i=o(e,t,a)
return-1<i?n[r?e[i]:i]:void 0}}},XpKX:function(e,t,a){e.exports={"mb-preview-page":"HpPhB83xskCxzhv6pRWDy","is-offline-mode":"_28_YiE-2ulr1BboXRcKxWW","is-uichina":"pxVKuNMBIglIQCw1n6NBA"}},XrEr:function(module,exports,__webpack_require__){"use strict"
...
function rgba(){var e=arguments[0],t=arguments[1],a=arguments[2],n=arguments[3]
return e<=1&&t<=1&&a<=1?{r:parseInt((0,_round.default)(255*e),10),g:parseInt((0,_round.default)(255*t),10),b:parseInt((0,_round.default)(255*a),10),a:Number(Number(n).toFixed(2))}:{r:e,g:t,b:a,a:void 0===n?1:n}}var _eval=eval(rgbaFuncStr),r=_eval.r,g=_eval.g,b=_eval.b,a=_eval.a
...
var getColorFromUnit=function(e,t){var a=1<arguments.length&&void 0!==t?t:RGBA
if(!e)return DEFAULT_COLOR
var n=checkColorUnit(e)
if(!n)return DEFAULT_COLOR
switch(n){case RGBA:if(a===n)return e
if(a===RGB)return rgba2rgb(e)
if(a===HEX)return rgba2hex(e)
if(a===ARGB)return rgba2argb(e)
break
case RGB:if(a===n)return e
if(a===RGBA)return rgb2rgba(e)
if(a===HEX)return rgb2hex(e)
if(a===ARGB)return rgb2argb(e)
break
case HEX:if(a===n)return e
if(a===RGBA)return hex2rgba(e)
if(a===RGB)return hex2rgb(e)
if(a===ARGB)return hex2argb(e)
break
case ARGB:if(a===n)return e
if(a===RGBA)return argb2rgba(e)
if(a===RGB)return argb2rgbWithA(e)
if(a===HEX)return argb2hexWithA(e)
break
case TRANSPARENT:if(a===RGBA)return RGBA_FOR_TRANSPARENT
if(a===RGB)return rgba2rgb(RGBA_FOR_TRANSPARENT)
if(a===HEX)return rgba2hex(RGBA_FOR_TRANSPARENT)
if(a===ARGB)return rgba2argb(RGBA_FOR_TRANSPARENT)
break
default:return e}}
...
var t=rgba2hexWithA(e),a=t.hex,n=t.o
return a?{rgb:hex2rgb(a),o:n}:DEFAULT_COLOR},hex2rgb=function(e){if(checkColorUnit(e)!==HEX)return console.warn("Not hexcolor but use hex2rgb"),e
if(3===(e=e.replace("#","")).length){var t=e.split(""),a=(0,_slicedToArray2.default)(t,3),n=a[0],r=a[1],i=a[2]
e="".concat(n).concat(n).concat(r).concat(r).concat(i).concat(i)}var o=parseInt(e.substring(0,2),16),l=parseInt(e.substring(2,4),16),s=parseInt(e.substring(4,6),16)
return"rgb(".concat(o,", ").concat(l,", ").concat(s,")")},rgba2rgb=function(e){var t=rgba2rgbWithA(e),a=t.rgb,n=t.o
return a?"".concat(a," ").concat(Math.round(100*n),"%"):e},rgba2hex=function(e){var t=rgba2hexWithA(e),a=t.hex,n=t.o
return a?"".concat(a.toUpperCase()," ").concat(Math.round(100*n),"%"):e},rgba2argb=function(e){if(checkColorUnit(e)!==RGBA)return console.warn("Not rgbacolor but use rgba2argb"),e
var t=rgba2hexWithA(e),a=t.hex,n=t.o
if(!a)return e
var r=("0"+parseInt(255*n,10).toString(16)).slice(-2).toUpperCase()
return"#".concat(r).concat(a.slice(1))},rgb2rgba=function(e){return checkColorUnit(e)!==RGB?(console.warn("Not rgbcolor but use rgb2rgba"),e):"rgba(".concat(e.slice(4,-1),", 1)")},rgb2hex=function(e){if(checkColorUnit(e)!==RGB)return console.warn("Not rgbcolor but use rgb2hex"),e
var t=e.match(/^rgb?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?/i)
if(t&&4===t.length){var a=("0"+parseInt(t[1],10).toString(16)).slice(-2),n=("0"+parseInt(t[2],10).toString(16)).slice(-2),r=("0"+parseInt(t[3],10).toString(16)).slice(-2)
return"#".concat(a).concat(n).concat(r).toUpperCase()}},rgb2argb=function(e){return checkColorUnit(e)!==RGB?(console.warn("Not rgbcolor but use rgb2argb"),e):hex2argb(rgb2hex(e))},hex2argb=function(e){return checkColorUnit(e)!==HEX?(console.warn("Not hexcolor but use hex2argb"),e):"#FF".concat(e.slice(1))},hex2rgba=function(e){return checkColorUnit(e)!==HEX?(console.warn("Not hexcolor but use hex2rgba"),e):rgb2rgba(hex2rgb(e))},argb2rgba=function(e){if(checkColorUnit(e)!==ARGB)return console.warn(
"Not argbcolor but use argb2rgba"),e
for(var t=[],a=1;a<e.length;a+=2)t.push(e.slice(a,a+2))
var n=t[0],r=t[1],i=t[2],o=t[3]
return r=parseInt(r,16),i=parseInt(i,16),o=parseInt(o,16),n=Number((parseInt(n,16)/255).toString().slice(0,4)),"rgba(".concat(r,", ").concat(i,", ").concat(o,", ").concat(n,")")},argb2rgbWithA=function(e){if(checkColorUnit(e)!==ARGB)return console.warn("Not argbcolor but use argb2rgbWithA"),e
var t=argb2rgba(e),a=rgba2rgbWithA(t),n=a.rgb,r=a.o
return n?"".concat(n," ").concat(Math.round(100*r),"%"):e},argb2hexWithA=function(e){if(checkColorUnit(e)!==ARGB)return console.warn("Not argbcolor but use argb2hexWithA"),e
var t=argb2rgba(e),a=rgba2hexWithA(t),n=a.hex,r=a.o
return n?"".concat(n.toUpperCase()," ").concat(Math.round(100*r),"%"):e},getUIColor=function getUIColor(color){if(!color)return DEFAULT_COLOR
...
exports.DEFAULT_COLOR=DEFAULT_COLOR},Y69h:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
try{r.default.MB.webpackInterface=(0,i.default)(o.default),r.default.MB.messageBucket=(0,l.createMessageBucket)()}catch(e){console.warn("[UI:Preview] Failed to init:",e.stack||e)}},ZS4k:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var i=r(a("PJYZ")),o=r(a("lSNA")),l=r(a("lwsE")),s=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("7W2i")),y=n(a("q1tI")),f=r(a("17x9")),p=a("vOnD"),h=r(a("i6OX")),b=a("wYtL"),m=r(a("QdB0")),S=r(a("5Mi5")),w=r(a("ULaQ")),E=r(a("Aa0X")),C=r(a("18l9")),k=r(a("jZq5")),_=r(a("DJvY")),x=r(a("DdUa")),T=r(a("2AqR")),M=r(a("nQhf")),P=r(a("xUDz")),I=r(a("NyBV")),N=r(a("ewu5")),R=r(a("mdx/")),v=r(a("gY5R")),L=a("1iCU"),g=r(a("XpKX")),j=r(a("UbMB")),A=a("/5+U");(0,a("aYxX").initI18n)(window.MBLocale)
var B=j.default.bind(g.default),O=window,D=O.MB,F=O.I18N,q=new Set(["ai@mockingbot.com","ethantw@me.com"]),U=function(e){function t(){return(0,l.default)(this,t),(0,c.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,s.default)(t,[{key:"render",value:function(){return y.default.createElement(p.ThemeProvider,{theme:v.default.light},y.default.createElement(W,this.props))}}]),t}(y.PureComponent)
t.default=U
var W=function(e){function r(e){var t;(0,l.default)(this,r),t=(0,c.default)(this,(0,u.default)(r).call(this,e)),(0,o.default)((0,i.default)(t),"handleClick",function(){V(),t.setState({showLoadtip:!1})})
var a=e.dispatch
...
this.props.dispatch({type:"event-sign-up:set:event",payload:t})}(0,A.canBackToWorkspace)()||D.event("zhuge","PreviewOrLinkPreview_enter",{User_id:"",ProjectCreator_id:D.currentProject.owner_id,via:"click",IF_User_ProjectCreator:!1,From:"Link"})}},{key:"render",value:function(){var e=this.props,t=e.isLite,a=e.project,n=e.previewSetting,r=e.isProjectFromOtherFreeUser,i=e.toastList,o=e.popupList,l=e.dispatch,s=this.state.showLoadtip
...
var c=a.owner_email,u=a.master,d=n.toolbarActiveItem,f=n.isFullScreenMode,p=d==L.PREVIEW,h=d==L.INSPECT,m=!D.isElectron()&&!D.isHTMLZip()&&h&&s&&z(),v=!u&&p&&(q.has(c)||r),g=B("mb-preview-page",{"is-offline-mode":D.isHTMLZip(),"is-uichina":D.isUIChina()||D.isForum(),"full-screen":f})
return y.default.createElement("div",{className:g},y.default.createElement(T.default,null),f&&y.default.createElement(P.default,null),y.default.createElement("div",{id:"preview-content-container",className:"preview-content-container"},y.default.createElement(E.default,null),y.default.createElement(_.default,null),y.default.createElement(k.default,null),y.default.createElement(C.default,null)),v||D.isUIChina()&&y.default.createElement("a",{className:"powered-by",href:"/",target:"_blank"},
y.default.createElement("img",{className:"zh",src:"/images/preview/watermark_zh.svg",alt:F.preview.powered_by_modao}),y.default.createElement("img",{className:"en",src:"/images/preview/watermark_en.svg",alt:F.preview.powered_by_modao})),y.default.createElement(H,{isActive:m,onClick:this.handleClick}),p&&y.default.createElement(I.default,null),y.default.createElement(M.default,null),y.default.createElement(w.default,null),y.default.createElement(S.default,{dispatch:l}),y.default.createElement(
b.TooltipGlobalStyle,null),y.default.createElement(N.default,{toastList:i}),y.default.createElement(R.default,{popupList:o}))}}]),r}(y.Component);(0,o.default)(W,"propTypes",{isLite:f.default.bool,project:f.default.object,previewSetting:f.default.object,isProjectFromOtherFreeUser:f.default.bool,toastList:f.default.array,popupList:f.default.array,dispatch:f.default.func})
var H=function(e){var t=e.isActive,a=e.onClick
...
var Y="close_client_load_tip",z=function(){return!D.localStorageDelegate.getItem(Y)},V=function(){return D.localStorageDelegate.setItem(Y,"true")}},aYzi:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=p,(0,d.default)(p,"propTypes",{canvasOffset:f.default.object,canvasRange:f.default.object,viewportWidth:f.default.number,viewportHeight:f.default.number,showRuler:f.default.bool,onScroll:f.default.func}),(0,d.default)(p,"defaultProps",{showRuler:!1})},bTYh:function(e,t,a){},bekf:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.CodeBox=void 0
var o=r(a("J4zp")),l=r(a("lwsE")),s=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("PJYZ")),f=r(a("7W2i")),p=r(a("lSNA")),h=n(a("q1tI")),i=r(a("17x9")),m=a("RUem"),v=a("qOCw"),g=function(e){function i(){var e,r;(0,l.default)(this,i)
for(var t=arguments.length,a=new Array(t),n=0;n<t;n++)a[n]=arguments[n]
return r=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(a))),(0,p.default)((0,d.default)(r),"renderCode",function(e){return{px:r.renderCss,dp:r.renderAndroidCode,pt:r.renderIos}[(0,v.selectWithlanguageUnit)(e)]()}),(0,p.default)((0,d.default)(r),"renderIos",function(){var e=r.props,t=e.code,a=e.language,n=e.text
return h.default.createElement(b,{code:t,language:a,text:n})}),(0,p.default)((0,d.default)(r),"renderCss",function(){var e=r.props,t=e.code,a=e.language
return h.default.createElement(y,{language:a,code:t})}),(0,p.default)((0,d.default)(r),"renderAndroidCode",function(){var e=r.props,t=e.whichAndView,a=e.code,n=e.text
return h.default.createElement(S,{code:a,text:n,whichAndView:t})}),r}return(0,f.default)(i,e),(0,s.default)(i,[{key:"render",value:function(){var e=this.props.language
...
var y=function(e){var t=e.language,a=e.code,r=w(t),i=E(t),n=k(a)
return Object.entries(n).map(function(e){var t=(0,o.default)(e,2),a=t[0],n=t[1]
return h.default.createElement("div",{key:a},"".concat(a).concat(i).concat(n).concat(r))})}
y.propTypes={code:i.default.object.isRequired,language:i.default.string}
var b=function(e){var t=e.code,a=e.text
return C({code:t,text:a}).map(function(e){return h.default.createElement("div",{key:e},e)})}
b.propTypes={code:i.default.object.isRequired,text:i.default.string}
var S=function(e){var t=e.code,a=e.text,n=e.whichAndView
return h.default.createElement("div",null,h.default.createElement("div",{className:"highlight-row"},"<".concat(n)),Object.entries(t).map(function(e){var t=(0,o.default)(e,2),a=t[0],n=t[1]
return h.default.createElement("div",{key:a},"android:".concat(a,'="').concat(n,'"'))}),0<a.length&&h.default.createElement("div",null,'android:text="'.concat(a,'"')),h.default.createElement("div",{className:"highlight-row"},"/>"))}
...
default:return": "}},C=function(e){var t=e.code,a=e.text,n=t.width,r=t.height,i=t.x,o=t.y,l=t.fontFamily,s=t.cornerRadius,c=t.fontSize,u=t.opacity,d=t.borderWidth,f=t.borderColor,p=t.alignment,h=t.backgroundColor,m=a?"textLayer":"layer",v=a?"UILabel":"UIView",g=[]
return g.push("let ".concat(m," = ").concat(v,"(frame: CGRect(x: ").concat(i,", y:").concat(o,", width: ").concat(n,", height: ").concat(r,"))")),h&&g.push("".concat(m,".backgroundColor = ").concat(h)),u&&g.push("".concat(m,".alpha = ").concat(u)),s&&g.push("layer.layer.cornerRadius = ".concat(s)),d&&g.push("layer.layer.borderWidth = ".concat(d)),f&&g.push("layer.layer.borderColor = ".concat(f,".cgColor")),a&&(g.push('let textContent = "'.concat(a,'"')),g.push(
...
return delete e["border-color"],delete e["border-width"],Object.assign(e,t)}return e}},cQH5:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var s=r(a("o0o1")),i=r(a("yXPU")),l=r(a("lwsE")),o=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("PJYZ")),f=r(a("7W2i")),p=r(a("lSNA")),h=r(a("17x9")),m=n(a("q1tI")),v=a("/MKj"),g=r(a("sEfC")),y=a("wYtL"),b=r(a("i6OX")),S=a("rbsZ"),w=r(a("prTy")),E=r(a("UbMB")),C=r(a("2s0x")),k=a("/5+U"),_=a("Nu6V"),x=a("upRB"),T=E.default.bind(C.default),M=!1,P=function(e){function r(e){var o;(0,l.default)(this,r),o=(0,c.default)(this,(0,u.default)(r).call(this,e)),(0,p.default)((0,d.default)(o),"handleActiveLayer",
...
break}return e.abrupt("return")
case 6:return o.startLoadSlice(),e.next=9,B(a,n)
...
n&&(M=!0,a({type:"reducer:preview-toolbar:update",payload:{loadSliceUrl:r}}))}},{key:"render",value:function(){var o=this,e=this.state,t=e.download,l=e.activeLayerId,a=this.props,n=a.slicesMap,r=a.loading,i=a.error,s=a.currentArtboardId,c=a.isLogin
return i||r?m.default.createElement(j,null):0===n.length?m.default.createElement(A,null):m.default.createElement("div",{className:T("slice-container")},n.map(function(e){var t=e.name,a=e.id,n=e.artboard_id,r=e.image,i=e.image_set
...
return m.default.createElement(y.Tooltip,{content:{click:n},type:"block",position:"top",arrowed:!1,className:T("download"),onClick:t},I18N.preview_panel.download,a?m.default.createElement(L,null):m.default.createElement(b.default,{type:"dora",name:"export",className:T("icon-download")}))}
N.propTypes={onClick:h.default.func,isLoading:h.default.bool,isLogin:h.default.bool}
function R(){return m.default.createElement("div",{className:T("layer-load")},m.default.createElement("span",{className:T("spinner")}))}var L=function(){return m.default.createElement("div",{className:T("download-slice-load")},m.default.createElement(R,null))},j=function(){return m.default.createElement("div",{className:T("slice-load-wrap")},m.default.createElement(R,null))},A=function(){return m.default.createElement("div",{className:T("no-slice")},m.default.createElement("img",{
src:"/images/preview/no-slice@2x.png"}),m.default.createElement("span",null,I18N.preview_panel.no_slice),m.default.createElement("span",null,I18N.preview_panel.slice_in_sketch),m.default.createElement("a",{href:window.MBSketchPluginDownloadURL},m.default.createElement("img",{src:"/images/preview/ic_sketch@2x.png",alt:"sketch"}),I18N.preview_panel.download_sketch))},B=function(){var a=(0,i.default)(s.default.mark(function e(t,a){var n,r,i,o,l
return s.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:n=!0,i=1
...
case 24:case"end":return e.stop()}},e)}))
return function(e,t){return a.apply(this,arguments)}}(),O=(0,v.connect)(function(e){var t=e.model,a=t.current.projectCid,n=t.user,r=e.container.slices,i=r.slices,o=r.loading,l=r.error,s=(0,x.getCurrentScreen)(e)
return{slicesMap:i,loading:o,error:l,isLogin:!!n.id,projectCid:a,currentArtboardId:s.artboard_id}})(P)
t.SliceContainer=O},gX9a:function(e,t,a){e.exports={"play-setting-menu":"W0ROskokXK_S7WUlDo7D5"}},gXld:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
if(n!==C.RECOMMEND&&n!==C.BETA||"literal"!==a){if("thumbnail"!==a)return"left"
...
t.default=x,(0,f.default)(x,"propTypes",{screenTreeData:o.default.object,screenCommentThreadCountMap:o.default.object,currentScreenCid:o.default.string,screenSearch:o.default.string,toolbarActiveItem:o.default.string,layout:o.default.string,isDemo:o.default.bool,dispatch:o.default.func})},h9XN:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.CopyBtn=void 0
var i=r(a("lwsE")),o=r(a("W8MJ")),l=r(a("a1gu")),s=r(a("Nsbk")),c=r(a("PJYZ")),u=r(a("7W2i")),d=r(a("lSNA")),f=n(a("q1tI")),p=r(a("17x9")),h=r(a("sxGJ")),m=a("wYtL"),v=a("/5+U"),g=r(a("mfFm")),y=function(e){function t(){var e
return(0,i.default)(this,t),(e=(0,l.default)(this,(0,s.default)(t).call(this))).onClipboardEvent=e.onClipboardEvent.bind((0,c.default)(e)),e}return(0,u.default)(t,e),(0,o.default)(t,[{key:"componentDidMount",value:function(){var t=this,e=this.props,a=e.target,n=e.text
this.clipboard=n?new h.default(this.$copyBtn,{text:function(){return(0,v.unescapeHTML)(document.querySelector(n).innerText)}}):new h.default(this.$copyBtn,{target:function(){return document.querySelector(a)}}),this.clipboard.on("success",function(e){t.error=!1,window.getSelection().removeAllRanges(),t.onClipboardEvent()}),this.clipboard.on("error",function(e){t.error=!0,t.onClipboardEvent()})}},{key:"componentWillUnmount",value:function(){this.clipboard.destroy()}},{key:"onClipboardEvent",value:function(){
...
t.CopyBtn=y,(0,d.default)(y,"propTypes",{target:p.default.string,text:p.default.string})},hQIM:function(e,t,a){t.__esModule=!0
var g=a("/Nf0"),y=a("jBRi")
function r(){return(r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var a=arguments[t]
for(var n in a)Object.prototype.hasOwnProperty.call(a,n)&&(e[n]=a[n])}return e}).apply(this,arguments)}function b(e,t,a,n){return r({},(0,y.createNode)(t),{key:e,size:a,expireAt:n})}t.createCache=b,t.createCacheMap=function(e){function l(e){h.set(e.key,e),m.unshift(e),v+=e.size,r&&p({type:"add",key:e.key,payload:e.value})}function s(e){h.delete(e.key),m.remove(e),v-=e.size,r&&p({type:"delete",key:e.key,payload:e.value})}var i=e.valueSizeSumMax,t=e.valueSizeSingleMax,o=void 0===t?Math.max(.05*i,1):t,
a=e.eventHub,n=void 0===a?(0,g.createHub)():a,r=Boolean(n),c=r?n:{},u=c.clear,d=c.subscribe,f=c.unsubscribe,p=c.send,h=new Map,m=(0,y.createDoublyLinkedList)(),v=0
return{hasEventHub:r,clearHub:u,subscribe:d,unsubscribe:f,clear:function(){return h.forEach(s)},getSize:function(){return h.size},getValueSize:function(){return v},set:function(e,t,a,n){void 0===a&&(a=1),void 0===n&&(n=Date.now()+6e4)
var r=h.get(e)
if(r&&s(r),!(o<a)){for(;i<a+v;)s(m.getTail().prev)
l(b(e,t,a,n))}},get:function(e,t){void 0===t&&(t=Date.now())
var a=h.get(e)
if(a)return a.expireAt<=t?s(a):(m.setFirst(a),a.value)},touch:function(e,t){void 0===t&&(t=Date.now()+6e4)
var a=h.get(e)
if(a)return a.expireAt=t,m.setFirst(a),a.value},delete:function(e){var t=h.get(e)
return t&&s(t),t&&t.value},packList:function(){var i=[]
return m.forEachReverse(function(e){var t=e.key,a=e.value,n=e.size,r=e.expireAt
return i.push({key:t,value:a,size:n,expireAt:r})}),i},parseList:function(e,o){return void 0===o&&(o=Date.now()),e.forEach(function(e){var t=e.key,a=e.value,n=e.size,r=e.expireAt,i=b(t,a,n,r)
i.expireAt<=o?s(i):l(i)})}}}},iKZC:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.doSaveWithSocketAndFallback=t.createAutoSaveQueue=void 0
var b=n(a("o0o1")),S=n(a("MVZn")),w=n(a("yXPU")),E=a("ZMzb"),C=a("/Nf0"),k=a("os03"),_=a("Clcl")
t.createAutoSaveQueue=function(e){var t=e.doSave,a=e.onError,n=e.delay,r=(0,C.createEventTarget)(),i=r.clear,o=r.addEventListener,l=r.removeEventListener,s=r.dispatchEvent,c=(0,k.createSaveQueue)({beforeSave:function(){return s({type:"beforesave"})},afterSave:function(){return s({type:"aftersave"})},doSave:t,onError:a}),u=c.clear,d=c.add,f=c.save,p=c.filter,h=c.getLength,m=c.getIsSaving,v=c.getSavingState,g=(0,E.createTimer)({func:f,delay:n}),y=g.start,b=g.stop,S=g.getDelay,w=g.setDelay
...
return b.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:if(l={chunkIndex:r,chunkIndexMax:i,saveChunkFirstInfo:f(s[0]),saveChunkLength:s.length,chunkAttempt:o,saveQueueIndex:y,saveQueueLength:d},e.prev=1,p())return e.next=5,(0,k.withTimeoutRetry)({retry:2,timeout:6e4,task:function(){var t=(0,w.default)(b.default.mark(function e(t){var a,n
...
return b.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return i=s[t],o=(0,S.default)({index:t,indexMax:a,saveItem:f(i)},l,{saveQueueIndex:y+t}),e.next=4,(0,k.withTimeoutRetry)({retry:4,timeout:1e5,task:function(){var t=(0,w.default)(b.default.mark(function e(t){var a,n
...
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function r(e){var t=e.layer,a=e.unit,n=e.ratio,r=e.showGlobal,i=e.userPickColor,o=void 0===i?[]:i,l=e.globalColor,s=void 0===l?[]:l,c=e.globalText,u=void 0===c?[]:c,d=e.documentColor,f=void 0===d?[]:d,p=e.screenColor,h=void 0===p?[]:p,m=e.language,v=e.colorUnit,g=e.dispatch,y=t.src_left,b=t.src_top,S=t.src_width,w=t.src_height,E=t.origin_width,C=t.origin_height,k=t.bd_radius,_=t.line_height,x=t.bg_colors,T=void 0===x?[]:x,M=t.borders,P=void 0===M?[]:M,I=t.i,N=t.display_name,R=t.padding,L=void 0===R?0:R,
j=t.hiddSpacing,A=void 0!==j&&j,B=t.text_styles,O=void 0===B?[]:B,D=t.alignment,F=t.vertical_alignment,q=t.image,U=t.text,W=t.letter_spacing,H=t.image_set_zip,Y=t.shadows,z=void 0===Y?[]:Y,V=t.inner_shadows,X=void 0===V?[]:V,J=t.rotation,Z=t.textShadows,G=void 0===Z?[]:Z,K=t.image_set,Q=void 0===K?[]:K,$=t.name,ee=0<P.length,te=0<T.length,ae=!!q,ne=0<O.length&&U&&(0,je.getTextContent)(t).length,re=0<z.length||0<G.length,ie=0<X.length,oe=H,le={left:y,top:b,width:E||S,height:C||w,borderRadius:k,opacity:t.o,
rotation:J,ratio:n,unit:a}
if("line"===$){var se=(0,Be.getLineGeneralInfo)(t,!0),ce=se.length,ue=se.thickness,de=se.angle
le.width=ce,le.height=ue,le.rotation=de}var fe=(0,je.getBaseAttributes)(le),pe=fe.adapterTop,he=fe.adapterLeft,me=fe.adapterWidth,ve=fe.adapterHeight,ge=fe.radius,ye=fe.opacity,be=fe.rotate,Se={lineHeight:_,letterSpacing:W,unit:a,ratio:n},we=(0,je.getTextAttributes)(Se),Ee=we.lineHeight,Ce=we.letterSpacing,ke="number"==typeof I?I?"italic":"normal":void 0,_e={textStyles:O,background:T,borders:P,shadows:z,innerShadows:X,colorUnit:v,ratio:n,unit:a},xe=(0,je.getCodeAttributes)(_e),Te=t.o&&100!=t.o?t.o/100:null,
Me=(0,Ae.transfromProptype)({attr:(0,Re.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:D,opacity:Te,borderRadius:ge},xe),language:m,unit:a}),Pe=ae?"ImageView":ne?"TextView":"View",Ie="screen"===t.type||t.kind?t.name:N,Ne="line"===t.name
return r?Le.default.createElement(Le.default.Fragment,null,Le.default.createElement(Oe.LayerName,{title:I18N.preview_panel.screen_name,value:Ie}),Le.default.createElement(Oe.GlobalAttributes,{adapterWidth:me,adapterHeight:ve,documentColor:f,globalText:u,globalColor:s,screenColor:h,userPickColor:o,colorUnit:v,dispatch:g})):Le.default.createElement("div",null,Le.default.createElement(Oe.LayerName,{value:Ie}),Le.default.createElement(Oe.BasicAttributes,{adapterTop:pe,adapterLeft:he,adapterWidth:me,
adapterHeight:ve,rotate:be,radius:ge,opacity:ye,unit:a,colorUnit:v}),ne&&Le.default.createElement(Oe.TextLayerInfo,{textStyles:O,alignment:D,vertical_alignment:F,lineHeight:Ee,letterSpacing:Ce,ratio:n,unit:a,o:t.o,padding:L,fontStyle:ke,colorUnit:v,hiddSpacing:A,text:(0,je.getTextContent)(t)}),te&&Le.default.createElement(Oe.Fills,{backgroundColorSort:T,colorUnit:v}),ee&&Le.default.createElement(Oe.BorderInfo,{isStroke:Ne,borderSort:P,ratio:n,unit:a,colorUnit:v}),re&&Le.default.createElement(Oe.Shadows,{
shadows:z,textShadows:G,colorUnit:v,unit:a,ratio:n}),ie&&Le.default.createElement(Oe.Shadows,{shadows:X,colorUnit:v,unit:a,ratio:n,isInnerShaow:!0}),oe&&Le.default.createElement(Oe.ImageInfo,{imageSetZip:H,name:t.display_name,imageSet:Q}),Le.default.createElement(Oe.CodeBox,{code:Me,whichAndView:Pe,language:m,text:(0,je.getTextContent)(t)||""}))}var Re=n(a("MVZn")),i=n(a("17x9")),Le=n(a("q1tI")),je=a("qOCw"),Ae=a("Ro3d"),Be=a("PqLM"),Oe=a("RUem")
...
return 0<a&&0<(void 0===n?1:n)}},jBRi:function(e,t){t.__esModule=!0
function r(e,t,a){return void 0===t&&(t=null),void 0===a&&(a=null),{value:e,prev:t,next:a}}t.createNode=r,t.createDoublyLinkedList=function(){function e(){i=new Set,o=r(null),l=r(null),(o.next=l).prev=o}var i,o,l
e()
function t(e,t){var a=t.next
t.next=a.prev=e,e.prev=t,e.next=a,i.add(e)}function a(e,t){var a=t.prev
t.prev=a.next=e,e.prev=a,e.next=t,i.add(e)}function n(e){var t=e.prev,a=e.next;(t.next=a).prev=t,e.prev=e.next=null,i.delete(e)}return{clear:e,getHead:function(){return o},getTail:function(){return l},getLength:function(){return i.size},insertAfter:t,insertBefore:a,remove:n,removeBetween:function(e,t){var a=e.prev,n=t.next;(a.next=n).prev=a,e.prev=t.next=null
for(var r=e;r;)i.delete(r),r=r.next},forEach:function(e){for(var t=o.next,a=0;t!==l;)e(t,a),t=t.next,a++},forEachReverse:function(e){for(var t=l.prev,a=i.size-1;t!==o;)e(t,a),t=t.prev,a--},reverse:function(){for(var e=o.next;e!==l;){var t=e,a=t.prev,n=t.next
e.prev=n,e.next=a,e=n}var r=o.next,i=l.prev
o.next=i,l.prev=r,i.prev=o,r.next=l},setFirst:function(e){if(e!==o.next){var t=e.prev,a=e.next;(t.next=a).prev=t,e.prev=o,e.next=o.next,o.next=e}},setLast:function(e){if(e!==l.prev){var t=e.prev,a=e.next;(t.next=a).prev=t,e.prev=l.prev,(e.next=l).prev=e}},push:function(e){return a(e,l)},pop:function(){return n(l.prev)},unshift:function(e){return t(e,o)},shift:function(){return n(o.next)}}}},jZq5:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=u},jbqJ:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var r=n(a("pVnL")),o=n(a("QILm")),l=n(a("lwsE")),s=n(a("W8MJ")),c=n(a("a1gu")),u=n(a("Nsbk")),d=n(a("PJYZ")),f=n(a("7W2i")),p=n(a("lSNA")),h=n(a("q1tI")),i=n(a("17x9")),m=a("6XO9"),v=function(e){function i(){var e,t;(0,l.default)(this,i)
for(var a=arguments.length,n=new Array(a),r=0;r<a;r++)n[r]=arguments[r]
return t=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,p.default)((0,d.default)(t),"handleChange",function(e){return t.props.onConfirm(e,t.props.attr)}),t}return(0,f.default)(i,e),(0,s.default)(i,[{key:"render",value:function(){var e=this.props,t=(e.attr,e.onConfirm,e.precision),a=e.dontSelectOnFocus,n=(0,o.default)(e,["attr","onConfirm","precision","dontSelectOnFocus"])
return h.default.createElement(m.PanelInputNumber,(0,r.default)({precision:t,dontSelectOnFocus:a,onConfirm:this.handleChange},n))}}]),i}(h.default.PureComponent);(t.default=v).propTypes={precision:i.default.number,dontSelectOnFocus:i.default.bool,value:i.default.oneOfType([i.default.string,i.default.number]),attr:i.default.oneOfType([i.default.string,i.default.array]),onConfirm:i.default.func},v.defaultProps={precision:0,dontSelectOnFocus:!0}},jeLk:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=o},jl5L:function(e,t,a){var i=a("Sxd8"),o=a("tLB3"),l=a("dt0z"),s=Math.min
e.exports=function(e){var r=Math[e]
return function(e,t){if(e=o(e),t=null==t?0:s(i(t),292)){var a=(l(e)+"e").split("e"),n=r(a[0]+"e"+(+a[1]+t))
return+((a=(l(n)+"e").split("e"))[0]+"e"+(+a[1]-t))}return r(e)}}},jvRN:function(e,t,a){"use strict"
var n=a("TqRt")
...
return i&&i[t]?i[t]:o.default[t]},C=function(e){var t=(0,u.getRichTextAttr)(e),a=t.fontFamily,n=t.fontWeight,r=t.fontSize,i=t.color,o=t.fontStyle,l=t.letterSpacing,s=t.lineHeight,c=t.paraSpacing
return{font_face:"".concat((0,d.getFontFamilyAndWeightText)(a,n)),font_size:r,color:i,fontStyle:o,letterSpacing:l,lineHeight:s,paraSpacing:c}},k=function(e,t){var a=(0,s.isChinese)(e)?"chinese":"english",n=h()?"mac":"windows",r=(0,i.getProjectPlatformByDevice)(t)
...
return E.default.createElement("li",{"data-cid":t,className:"rn-content-item"},E.default.createElement(C.default,{depth:n,screen:h,isLinked:y,isActive:g,isEditing:b,hoverCid:d,showExpander:S,renderItem:f,collapseKeySet:c,handleScreenItemActions:p}),v&&m&&E.default.createElement("ol",{type:"screen-list",className:"child-screens"},v.map(function(e){var t=e.cid
...
t.default=v,(0,f.default)(v,"propTypes",{className:h.default.string,menuClassName:h.default.string})},m9na:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.CheckboxGroup=t.RadioGroup=t.CheckerLabel=void 0
var l=r(a("PJYZ")),s=r(a("lwsE")),o=r(a("W8MJ")),c=r(a("a1gu")),u=r(a("Nsbk")),d=r(a("7W2i")),f=r(a("lSNA")),p=n(a("q1tI")),i=r(a("17x9"))
a("I19b")
var h=function(e){function t(){return(0,s.default)(this,t),(0,c.default)(this,(0,u.default)(t).apply(this,arguments))}return(0,d.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=this.props,t=e.type,a=e.className,n=e.isChecked,r=e.isDisabled,i=e.onClick,o=e.children
return p.default.createElement("label",{className:"\n        ".concat(t,"-label\n        ").concat(n?"is-checked":"","\n        ").concat(r?"is-disabled":"","\n        ").concat(a,"\n        ")},p.default.createElement("button",{className:"checker",onClick:i,disabled:r}),o)}}]),t}(p.PureComponent)
...
var m=function(e){function i(){var e,a;(0,s.default)(this,i)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
return a=(0,c.default)(this,(e=(0,u.default)(i)).call.apply(e,[this].concat(n))),(0,f.default)((0,l.default)(a),"createOnChangeHandler",function(e,t){return function(){return a.props.onChange(e,t)}}),a}return(0,d.default)(i,e),(0,o.default)(i,[{key:"render",value:function(){var a=this,e=this.props,t=e.className,n=e.optionList,r=e.currentOptionIdx,i=e.isDisabled
return p.default.createElement("span",{className:"radio-group ".concat(t," ").concat(i?"is-disabled":"")},n.map(function(e,t){return e&&p.default.createElement(h,{key:t,type:"radio",isChecked:t===r,isDisabled:i||e.isDisabled,onClick:!(i||e.isDisabled)&&a.createOnChangeHandler(e.val,t)},e.name)}))}}]),i}(p.PureComponent)
...
var v=function(e){function r(){var e,o;(0,s.default)(this,r)
for(var t=arguments.length,a=new Array(t),n=0;n<t;n++)a[n]=arguments[n]
return o=(0,c.default)(this,(e=(0,u.default)(r)).call.apply(e,[this].concat(a))),(0,f.default)((0,l.default)(o),"createOnChangeHandler",function(i){return function(){var e=o.props,t=e.onChange,a=e.currentOptionIdxList,n=new Set(a),r=n.has(i)?"delete":"add"
n[r](i),t(n)}}),o}return(0,d.default)(r,e),(0,o.default)(r,[{key:"render",value:function(){var a=this,e=this.props,t=e.className,n=e.optionList,r=e.currentOptionIdxList,i=e.isDisabled,o=new Set(r)
return p.default.createElement("span",{className:"checkbox-group ".concat(t," ").concat(i?"is-disabled":"")},n.map(function(e,t){return e&&p.default.createElement(h,{key:t,type:"check",onClick:a.createOnChangeHandler(t),isDisabled:i||e.isDisabled,isChecked:o.has(t)},e.name)}))}}]),r}(p.PureComponent)
t.CheckboxGroup=v,(0,f.default)(v,"propTypes",{className:i.default.string,onChange:i.default.func,optionList:i.default.array,currentOptionIdxList:i.default.oneOfType([i.default.instanceOf(Set),i.default.array]),isDisabled:i.default.bool}),(0,f.default)(v,"defaultProps",{className:"",currentOptionIdxList:new Set})},"mC/1":function(e,t,a){"use strict"
var n=a("TqRt")
...
t.default=o},mfFm:function(e,t,a){e.exports={"global-attributes":"_7IJUmxJU-0pBWIkSjwqow","layer-name":"_1fsrzxYfz402VBIZ-DlMTP",header:"-zoI2C4ZHr_0l9t7KRYyj",panel:"zM5VvfRQZAspJENmHJ6ur",container:"_2vnSJjqQz99w4bRRbOUZJI",copyBtn:"_3jCESy5izi8-tdVWEWV4At CpKVZuffOrTLzsddLyYDD","layer-load":"_1t4w9RKi0eRPtciV2rnYnP",spinner:"_2UWcFkBUBt-gOxQ-MhiSbD","rotate-infinite":"_2rlU4rEKcXWZvnvVLrx0xJ"}},mggN:function(e,t,a){"use strict"
...
a("q1tI")),v=r(a("DKAG")),g=r(a("p2ZH")),y=r(a("2b0G")),b=r(a("4QcC")),S=r(a("ER7e")),w=r(a("Kurm")),E=r(a("TSYQ")),C=function(e){function t(e){var l
...
t.default=C,(0,f.default)(C,"propTypes",{dispatch:h.default.func,screen:h.default.object,screenInOrder:h.default.array,scale:h.default.number})},oKLx:function(e,t,a){},oQ6s:function(e,t,a){},oSKl:function(e,t,a){},oose:function(e,t,a){"use strict"
var n=a("TqRt")
...
t.getProjectAllowCommentStatus=C},os03:function(e,t,a){"use strict"
var n=a("TqRt")
...
var n=a("abHt"),r=MB.serverCountry
t.SERVER_COUNTRY=r
t.BETA="beta"
t.CLASSIC="classic"
...
t.RECOMMEND_LIBRARY_BASIC_WIDGETS=l},peLG:function(e,t,a){},prTy:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.sagaMap=c},qOCw:function(e,t,a){"use strict"
var n=a("TqRt")
...
var m=n(a("RIqP")),r=n(a("wig9")),i=n(a("7tbW")),x=a("/5+U"),o=a("LbTH"),T=a("XrEr")
t.getTextContent=function(e){return(0,o.checkIfItemTextIsNewVersion)(e)?function(e){return JSON.parse(e).reduce(function(e,t,a,n){return e+(0===a?"":"\n")+t.children.reduce(function(e,t,a){return e+t.text},"")},"")}(e.text):function(e){return!!e&&e.replace(/<[^>]+>/gi,"")}(e.text)}
t.getBaseAttributes=function(e){var t=e.width,a=e.height,n=e.left,r=e.top,i=e.opacity,o=e.borderRadius,l=e.rotation,s=e.ratio,c=e.unit,u=(0,x.adapterScreen)(n,s,c),d=(0,x.adapterScreen)(r,s,c),f=(0,x.adapterScreen)(t,s,c),p=(0,x.adapterScreen)(a,s,c),h=o?String(o).split(",").map(function(e){return(0,x.adapterScreen)(parseInt(e)||0,s,c)}).join(" "):null,m=v(l)?null:"".concat(l,"°")
...
t.getTextAttributes=function(e){var t=e.lineHeight,a=e.letterSpacing,n=e.unit,r=e.ratio
return{lineHeight:t=v(t)?null:(0,x.adapterScreen)(t,r,n),letterSpacing:a=v(a)?null:(0,x.adapterScreen)(a,r,n)}}
t.sortScreenLayers=function(e){var p=[],h=[]
return e.forEach(function(e){var t=e.bg_colors,a=void 0===t?[]:t,n=e.borders,r=void 0===n?[]:n,i=e.text_styles,o=void 0===i?[]:i,l=0<o.length?o[0]:{},s=l.color,c=l.font_face,u=[]
a.length&&(u=a.map(function(e){var t=e.value,a=e.type,n=void 0===a?"color":a,r=e.gradient,i=(0,T.getNormalRgbaColor)(t)
return"color"===n?i:y(r)})),u=g(u)
var d=[]
r.length&&(d=r.map(function(e){var t=e.color
return(0,T.getNormalRgbaColor)(t)})),d=g(d)
var f=s&&(0,T.getColorFromUnit)((0,T.parseSketchColor2rgba)(s),"rgba")
p.includes(f)||p.push(f),h.includes(c)||h.push(c),p=!(p=!p.includes(u)&&[].concat((0,m.default)(p),(0,m.default)(u))).includes(d)&&[].concat((0,m.default)(p),(0,m.default)(d))}),{screenColor:(0,i.default)((0,r.default)(p)).slice(0,14)||[],globalText:(0,r.default)(h)}}
var g=function(e){var t
return(t=[]).concat.apply(t,(0,m.default)(e))}
t.getCodeAttributes=function(e){var t,a,n,r,i,o,l,s,c,u=e.textStyles,d=e.borders,f=e.background,p=e.shadows,h=e.innerShadows,m=(e.colorUnit,e.unit),v=e.ratio
if(u.length){var g=u[0],y=g.color,b=g.font_size,S=g.font_face
t=y&&(0,T.getNormalRgbaColor)(y),a=(0,x.adapterScreen)(b,v,m),n=S}if(d.length){var w=d[0],E=w.position,C=void 0===E?"inside":E,k=w.color,_=w.thickness
r=(0,x.adapterScreen)(_,v,m),o=C,k&&(i=(0,T.getNormalRgbaColor)(k))}return f.length&&(l=(0,T.getNormalRgbaColor)(f[0].value)),p.length&&(s=M(p,m,v)),h.length&&(c=M(h,m,v,!0),s="".concat(s,", ").concat(c)),{fontFamily:n,fontSize:a,color:t,borderWidth:r,borderColor:i,borderPosition:o,backgroundColor:l,boxShadow:s}}
t.reduceTextLayer=function(e){if(0===e.length)return[]
var t=e.reduce(function(e,t){var a=t.font
return e.concat(a)},[])
return(0,m.default)(new Set(t))}
var M=function(e,g,y,t){var b=3<arguments.length&&void 0!==t&&t,S=e.length
return e.reduce(function(e,t,a){var n=t.color,r=t.offset_x,i=void 0===r?0:r,o=t.offset_y,l=void 0===o?0:o,s=t.blur_radius,c=void 0===s?0:s,u=t.spread,d=void 0===u?0:u,f=(0,x.adapterScreen)(i,y,g),p=(0,x.adapterScreen)(l,y,g),h=(0,x.adapterScreen)(c,y,g)
d=(0,x.adapterScreen)(d,y,g),n=(0,T.getNormalRgbaColor)(n)
var m=a<S-1?", ":"",v=b?"inset ":""
...
default:return"px"}}},qY2g:function(e,t,a){},qYFl:function(e,t,a){"use strict"
var n=a("TqRt")
...
t.StyledPreviewPanel=r},r1rb:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var r=n(a("pVnL")),i=n(a("lwsE")),o=n(a("W8MJ")),l=n(a("a1gu")),s=n(a("Nsbk")),c=n(a("7W2i")),u=n(a("q1tI")),d=a("6XO9"),f=function(e){function t(){return(0,i.default)(this,t),(0,l.default)(this,(0,s.default)(t).apply(this,arguments))}return(0,c.default)(t,e),(0,o.default)(t,[{key:"render",value:function(){var e=(0,r.default)({},this.props)
return u.default.createElement(d.Tooltip,e)}}]),t}(u.default.PureComponent)
t.default=f},rESR:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=C,(0,p.default)(C,"propTypes",{project:m.default.object.isRequired,screensCount:m.default.number.isRequired,toolbarActiveItem:m.default.string.isRequired,isDemo:m.default.bool})},rj4U:function(e,t,a){e.exports={"sub-toolbar":"_1lHJrguhCEQomzI0fKyRuD","select-input":"_3UQjksfyW2n5lPbsPnEgJv"}},rtgd:function(e,t,a){e.exports={"preview-toolbar":"_2GvcxT6MMVgPVqZ4pTagSW"}},rwIS:function(e,t,a){e.exports={"guide-button":"_30xMHfnBUgdhrZI7AsHGRs"}},sEfC:function(e,t,a){var y=a("GoyQ"),b=a("QIyF"),S=a(
"tLB3"),w=Math.max,E=Math.min
e.exports=function(n,a,e){var r,i,o,l,s,c,u=0,d=!1,f=!1,t=!0
if("function"!=typeof n)throw new TypeError("Expected a function")
function p(e){var t=r,a=i
return r=i=void 0,u=e,l=n.apply(a,t)}function h(e){var t=e-c
return void 0===c||a<=t||t<0||f&&o<=e-u}function m(){var e=b()
if(h(e))return v(e)
s=setTimeout(m,function(e){var t=a-(e-c)
return f?E(t,o-(e-u)):t}(e))}function v(e){return s=void 0,t&&r?p(e):(r=i=void 0,l)}function g(){var e=b(),t=h(e)
if(r=arguments,i=this,c=e,t){if(void 0===s)return function(e){return u=e,s=setTimeout(m,a),d?p(e):l}(c)
if(f)return s=setTimeout(m,a),p(c)}return void 0===s&&(s=setTimeout(m,a)),l}return a=S(a)||0,y(e)&&(d=!!e.leading,o=(f="maxWait"in e)?w(S(e.maxWait)||0,a):o,t="trailing"in e?!!e.trailing:t),g.cancel=function(){void 0!==s&&clearTimeout(s),r=c=i=s=void(u=0)},g.flush=function(){return void 0===s?l:v(b())},g}},tBsX:function(e,t,a){"use strict"
var n=a("TqRt")
...
t.default=p},tLB3:function(e,t){e.exports=function(e){return e}},tRkt:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=s},tpxX:function(e,t,a){var n=a("jl5L")("round")
e.exports=n},uW4e:function(e,t,a){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
function n(i,o){return c(function(e,t,a){var n=t.dispatch,r=a&&a.payload
...
t.default=p,(0,f.default)(p,"propTypes",{layer:i.default.object,requestSelectLayer:i.default.func,enterLayer:i.default.func,handleShowlayerInfo:i.default.func,activeLayerID:i.default.oneOfType([i.default.number,i.default.string]),enteredLayerID:i.default.oneOfType([i.default.number,i.default.string]),unit:i.default.string,ratio:i.default.number})},wQP3:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.TextLayerInfo=void 0
function r(e){var t=e.textStyles,a=void 0===t?[]:t,n=e.hiddSpacing,d=e.ratio,r=e.alignment,i=e.vertical_alignment,o=e.lineHeight,l=e.letterSpacing,f=e.unit,s=e.text,p=(e.o,e.colorUnit),h=e.fontStyle
return e.padding,m.default.createElement(v.WrapComponent,null,I18N.preview_panel.font,(0<a.length&&a.slice(0,1)).map(function(e,t){var a=e.color,n=e.font_size,r=e.location,i=e.font_face,o=e.fontStyle,l=(0,y.parseSketchColor2rgba)(a),s=(0,y.getColorFromUnit)(l,"rgba"),c=(0,g.adapterScreen)(n,d,f),u=(0,y.getColorFromUnit)(l,p)
return m.default.createElement("div",{key:"".concat(n).concat(r).concat(t)},i&&m.default.createElement(v.Base,{title:I18N.preview_panel.type_face,data:[i]}),(o||h)&&m.default.createElement(v.Base,{title:I18N.preview_panel.font_style,data:[o||h]}),s&&m.default.createElement(v.ColorInfo,{stateColor:u,title:I18N.preview_panel.color,rgbaColor:s}),c&&m.default.createElement(v.Base,{title:I18N.preview_panel.font_size,data:[c]}))}),r&&m.default.createElement(v.Base,{title:I18N.preview_panel.align,data:[r,i||"auto"
],dataValue:[I18N.preview_panel.horizontal_align,I18N.preview_panel.vertical_align]}),void 0!==a[0].paraSpacing?m.default.createElement(v.Base,{title:I18N.preview_panel.graph,data:[a[0].letterSpacing,a[0].lineHeight,a[0].paraSpacing],dataValue:[I18N.letter_spacing,I18N.text_line_height,I18N.para_spacing]}):o&&m.default.createElement(v.Base,{title:I18N.preview_panel.graph,data:[o,l||"auto"],dataValue:[I18N.preview_panel.line_height,I18N.preview_panel.letter_spacing],first:n}),s&&m.default.createElement(
v.Base,{text:s,title:I18N.preview_panel.content}))}var m=n(a("q1tI")),i=n(a("17x9")),v=a("RUem"),g=a("/5+U"),y=a("XrEr");(t.TextLayerInfo=r).propTypes={textStyles:i.default.array,fontStyle:i.default.string,alignment:i.default.string,vertical_alignment:i.default.string,hiddSpacing:i.default.bool,letterSpacing:i.default.oneOfType([i.default.string,i.default.bool]),lineHeight:i.default.oneOfType([i.default.string,i.default.bool]),paraSpacing:i.default.number,ratio:i.default.number,unit:i.default.string,
text:i.default.string,o:i.default.number,padding:i.default.number,colorUnit:i.default.string}},wYtL:function(e,t,a){"use strict"
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),Object.defineProperty(t,"FormEntry",{enumerable:!0,get:function(){return c.FormEntry}}),Object.defineProperty(t,"FormLabel",{enumerable:!0,get:function(){return c.FormLabel}}),Object.defineProperty(t,"CheckerLabel",{enumerable:!0,get:function(){return u.CheckerLabel}}),Object.defineProperty(t,"RadioGroup",{enumerable:!0,get:function(){return u.RadioGroup}}),Object.defineProperty(t,"CheckboxGroup",{enumerable:!0,get:function(){return u.CheckboxGroup}}),
t.TooltipGlobalStyle=t.Select=t.Check=t.InputNumber=t.Tooltip=t.Input=void 0
var i=r(a("VkAN")),o=a("00a+"),l=a("6XO9"),s=n(a("vOnD")),c=a("TT1N"),u=a("m9na"),d=r(a("Rm7n")),f=r(a("MzIM")),p=r(a("jbqJ")),h=r(a("r1rb"))
...
t.Tooltip=S
var w=(0,s.createGlobalStyle)(m())
t.TooltipGlobalStyle=w
var E=(0,s.default)(b).withConfig({displayName:"form__InputNumber",componentId:"sc-1t7hcl8-0"})(["&.is-valid:not(.unstyled){.title{color:#8d9ea7;}input{color:#415058;background-color:",";border:1px solid ",";}}&.is-valid.is-disabled{.title{opacity:1;color:#e8e8e8;}input{color:#c8cdd0;opacity:1;background-color:",";border:1px solid ",";}}"],function(e){return e.theme.draggablePanel.NumberInput.bg},function(e){return e.theme.draggablePanel.NumberInput.border_color},function(e){
...
t.InputNumber=E
var C=(0,s.default)(g).withConfig({displayName:"form__Check",componentId:"sc-1t7hcl8-1"})(["&.small.is-checked{.Check-state{background-color:#fff;border-color:",";color:#ff6161;}}"],function(e){return e.theme.draggablePanel.CheckBorder.border_color})
t.Check=C
var k=(0,s.default)(y).withConfig({displayName:"form__Select",componentId:"sc-1t7hcl8-2"})(["&.small:not(.unstyled){background-color:",";border:1px solid ",";}"],function(e){return e.theme.draggablePanel.Select.bg},function(e){return e.theme.draggablePanel.Select.border_color})
t.Select=k},wfO3:function(e,t,a){},wmEP:function(e,t,a){"use strict"
var n=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var n=a("284h"),r=a("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var v=r(a("MVZn")),i=r(a("pVnL")),o=r(a("lwsE")),l=r(a("W8MJ")),s=r(a("a1gu")),c=r(a("Nsbk")),u=r(a("7W2i")),d=r(a("lSNA")),f=r(a("17x9")),p=n(a("q1tI")),h=a("/MKj"),m=r(a("J2m7")),g=r(a("sxGJ")),y=a("RUem"),b=a("qOCw"),S=a("/5+U"),w=r(a("inTe")),E=r(a("xn7q")),C=function(e){function r(){var t
...
return p.default.createElement("div",{className:E.default.previewPanelLayer},a?p.default.createElement("div",{className:E.default.layerInfo,ref:this.getScrollLayerRef},n?p.default.createElement(r.Error,null):p.default.createElement(w.default,(0,i.default)({},this.props,{showGlobal:!t}))):p.default.createElement(y.Loading,null))}}]),r}(p.PureComponent);(0,d.default)(C,"Error",function(){return p.default.createElement("div",null,"Sorry!Error happend, Please refresh it")}),(0,d.default)(C,"propTypes",{
...
var k=(0,h.connect)(function(e){var t=e.container,a=t.layers,n=a.activeLayerID,r=a.visibilityScreenID,i=a.resourceByScreen,o=t.previewSetting,l=e.model,s=l.current,c=s.screenCid,u=s.projectCid,d=l.projects,f=o.isSelectLayer,p=x(d,u).device,h=T(f,i,r,n),m=_(i,r,p)
return(0,v.default)({},o,{layer:h},m,{screenCid:c})})(C)
t.default=k
var _=(0,S.immutableTransformCache)(function(e,t,a){var n=[],r=[],i=[],o=[],l=e[t]
if(l){var s=l.layers,c=(0,b.sortScreenLayers)(s)
n=c.screenColor,o=c.globalText,r=l.documentColor,i=l.globalColor}return{screenColor:n,documentColor:r,globalColor:i,globalText:o}}),x=(0,S.immutableTransformCache)(function(e,t){return e.find(function(e){return e.cid===t})}),T=(0,S.immutableTransformCache)(function(e,t,a,n){var r=t[a]
...
//# sourceMappingURL=preview-16799881e8383a57015e.js.map